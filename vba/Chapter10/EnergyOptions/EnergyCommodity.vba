...
'// Energy Swaption
Public Function EnergySwaption(CallPutFlag As String, F As Double, X As Double, T As Double, Tb As Double, rj As Double, rb As Double, j As Integer, n As Integer, v As Double) As Double
...
Public Function EEnergySwaption(OutPutFlag As String, CallPutFlag As String, F As Double, X As Double, T As Double, Tb As Double, rj As Double, rb As Double, j As Integer, n As Integer, v As Double, Optional dS)
...
Public Function EnergySwaptionApproximation(CallPutFlag As String, F As Double, X As Double, T As Double, Tm As Double, re As Double, v As Double) As Double
...
Public Function EEnergySwaptionApproximation(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, Tm As Double, re As Double, v As Double, Optional dS)
...
Public Function BlackScholesForward(CallPutFlag As String, F As Double, X As Double, T As Double, Tf As Double, r As Double, v As Double) As Double
...
Public Function EBlackScholesForward(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, Tf As Double, r As Double, v As Double, Optional dS)
