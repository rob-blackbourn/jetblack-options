...
Function CTND(LIMIT1 As Double, LIMIT2 As Double, LIMIT3 As Double, SIGMA1 As Double, SIGMA2 As Double, SIGMA3 As Double) As Double
    '
...
Function TRVFND(T As Double, B2 As Double, B3 As Double, RHO21 As Double, RHO31 As Double, rho As Double)
    TRVFND = Exp(-T * T / 2) * CBND(-T * RHO21 + B2, -T * RHO31 + B3, rho)
End Function

Function ADONED(A As Double, b As Double, TOL As Double, b2p As Double, b3p As Double, RHO21 As Double, RHO31 As Double, rho As Double) As Double
    '
...
Function KRNRDD(A As Double, b As Double, ABSERR As Double, b2p As Double, b3p As Double, RHO21 As Double, RHO31 As Double, rho As Double) As Double
    '
    ' Kronrod Rule
    '
    ...
    For j = 1 To N
        ABSCIS = HFLGTH * XGK(j)
        FUNSUM = TRVFND(CENTER - ABSCIS, b2p, b3p, RHO21, RHO31, rho) + TRVFND(CENTER + ABSCIS, b2p, b3p, RHO21, RHO31, rho)
