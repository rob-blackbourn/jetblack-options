"""Tests for Black-Scholes-Merton European options"""
...
def test_delta():
    ...
    for is_call, S, K, r, q, T, v, expected in [
        ...
        numeric = ng[is_call].delta(S, K, T, r, q, v)
...
def test_gamma():
    ...
    for is_call, S, K, r, q, T, v, expected in [
        ...
        numeric = ng[is_call].gamma(S, K, T, r, q, v)
        assert is_close_to(numeric, analytic, 1e-5)
...
def test_theta():
    ...
    for is_call, S, K, r, q, T, v, expected in [
        ...
        numeric = ng[is_call].theta(S, K, T, r, q, v)
...
def test_vega():
    ...
    for is_call, S, K, r, q, T, v, expected in [
        ...
        numeric = ng[is_call].vega(S, K, T, r, q, v)
...
def test_rho():
    ...
    for is_call, S, K, r, q, T, v, expected in [
        ...
        numeric = ng[is_call].rho(S, K, T, r, q, v)
        assert is_close_to(numeric, analytic, 1e-4)
...
def test_elasticity():
    ...
    for is_call, S, K, r, q, T, v, expected in [
        ...
        numeric = ng[is_call].elasticity(S, K, T, r, q, v)
        assert is_close_to(numeric, analytic, 1e-4)
...
def test_dgamma_dvol():
    ...
    for is_call, S, K, r, q, T, v, expected in [
        ...
        numeric = ng[is_call].dgamma_dvol(S, K, T, r, q, v)
        assert is_close_to(numeric, analytic, 1e-4)
...
def test_gammap():
    ...
    for is_call, S, K, r, q, T, v, expected in [
        ...
        numeric = ng[is_call].gammap(S, K, T, r, q, v)
        assert is_close_to(numeric, analytic, 1e-5)
...
def test_vanna():
    ...
    for is_call, S, K, r, q, T, v, expected in [
        ...
        numeric = ng[is_call].vanna(S, K, T, r, q, v)
        assert is_close_to(numeric, analytic, 1e-4)
...
def test_charm():
    ...
    for is_call, S, K, r, q, T, v, expected in [
        ...
        numeric = ng[is_call].charm(S, K, T, r, q, v)
        assert is_close_to(numeric, analytic, 1e-5)
...
def test_vegap():
    ...
    for is_call, S, K, r, q, T, v, expected in [
        ...
        numeric = ng[is_call].vegap(S, K, T, r, q, v)
        assert is_close_to(numeric, analytic, 1e-3)
...
def test_vomma():
    ...
    for is_call, S, K, r, q, T, v, expected in [
        ...
        numeric = ng[is_call].vomma(S, K, T, r, q, v)
