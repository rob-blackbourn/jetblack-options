...
from jetblack_options.american.bjerksund_stensland_2002.analytic import price
...
def test_delta():
    ...
    for is_call, S, K, r, q, T, v, expected in [
        ...
        (True, 100, 110, 0.1, 0.08, 6/12, 0.125, 0.1715303519709721),
...
def test_gamma():
    ng = NumericGreeks(price)
    for is_call, S, K, r, q, T, v, expected in [
        (True, 110, 100, 0.1, 0.08, 6/12, 0.125, 0.01855356346780468),
        (False, 110, 100, 0.1, 0.08, 6/12, 0.125, 0.018941028372410074),
        (True, 100, 100, 0.1, 0.08, 6/12, 0.125, 0.04284073433780122),
        (False, 100, 100, 0.1, 0.08, 6/12, 0.125, 0.04794256739160119),
        (True, 100, 110, 0.1, 0.08, 6/12, 0.125, 0.028376565381904584),
        (False, 100, 110, 0.1, 0.08, 6/12, 0.125, 0.04379615301530748),
    ]:
        b = r - q
