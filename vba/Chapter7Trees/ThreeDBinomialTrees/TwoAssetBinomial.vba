...
Public Function PayoffFunction(TypeFlag As Integer, CallPutFlag As String, S1 As Double, S2 As Double, Q1 As Double, Q2 As Double, X1 As Double, X2 As Double) As Double
