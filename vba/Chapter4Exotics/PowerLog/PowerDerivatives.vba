...
Public Function CappedPowerOption(CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, i As Double, c As Double) As Double
...
Public Function ECappedPowerOption(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, i As Double, c As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        ECappedPowerOption = (CappedPowerOption(CallPutFlag, S + dS, X, T, r, b, v + 0.01, i, c) - 2 * CappedPowerOption(CallPutFlag, S, X, T, r, b, v + 0.01, i, c) + CappedPowerOption(CallPutFlag, S - dS, X, T, r, b, v + 0.01, i, c) - CappedPowerOption(CallPutFlag, S + dS, X, T, r, b, v - 0.01, i, c) + 2 * CappedPowerOption(CallPutFlag, S, X, T, r, b, v - 0.01, i, c) - CappedPowerOption(CallPutFlag, S - dS, X, T, r, b, v - 0.01, i, c)) / (2 * 0.01 * dS ^ 2) / 100
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        ECappedPowerOption = 1 / (4 * dS * 0.01) * (CappedPowerOption(CallPutFlag, S + dS, X, T, r, b, v + 0.01, i, c) - CappedPowerOption(CallPutFlag, S + dS, X, T, r, b, v - 0.01, i, c) - CappedPowerOption(CallPutFlag, S - dS, X, T, r, b, v + 0.01, i, c) + CappedPowerOption(CallPutFlag, S - dS, X, T, r, b, v - 0.01, i, c)) / 100
    ...
    ElseIf OutPutFlag = "s" Then 'Speed
        ECappedPowerOption = 1 / dS ^ 3 * (CappedPowerOption(CallPutFlag, S + 2 * dS, X, T, r, b, v, i, c) - 3 * CappedPowerOption(CallPutFlag, S + dS, X, T, r, b, v, i, c) + 3 * CappedPowerOption(CallPutFlag, S, X, T, r, b, v, i, c) - CappedPowerOption(CallPutFlag, S - dS, X, T, r, b, v, i, c))
...
Public Function PoweredOptioni2(CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double) As Double
...
Public Function EPoweredOptioni2(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EPoweredOptioni2 = (PoweredOptioni2(CallPutFlag, S + dS, X, T, r, b, v + 0.01) - 2 * PoweredOptioni2(CallPutFlag, S, X, T, r, b, v + 0.01) + PoweredOptioni2(CallPutFlag, S - dS, X, T, r, b, v + 0.01) - PoweredOptioni2(CallPutFlag, S + dS, X, T, r, b, v - 0.01) + 2 * PoweredOptioni2(CallPutFlag, S, X, T, r, b, v - 0.01) - PoweredOptioni2(CallPutFlag, S - dS, X, T, r, b, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EPoweredOptioni2 = 1 / (4 * dS * 0.01) * (PoweredOptioni2(CallPutFlag, S + dS, X, T, r, b, v + 0.01) - PoweredOptioni2(CallPutFlag, S + dS, X, T, r, b, v - 0.01) - PoweredOptioni2(CallPutFlag, S - dS, X, T, r, b, v + 0.01) + PoweredOptioni2(CallPutFlag, S - dS, X, T, r, b, v - 0.01)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        EPoweredOptioni2 = (PoweredOptioni2(CallPutFlag, S, X, T, r, b + 0.01, v) - PoweredOptioni2(CallPutFlag, S, X, T, r, b - 0.01, v)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        EPoweredOptioni2 = 1 / dS ^ 3 * (PoweredOptioni2(CallPutFlag, S + 2 * dS, X, T, r, b, v) - 3 * PoweredOptioni2(CallPutFlag, S + dS, X, T, r, b, v) + 3 * PoweredOptioni2(CallPutFlag, S, X, T, r, b, v) - PoweredOptioni2(CallPutFlag, S - dS, X, T, r, b, v))
     ElseIf OutPutFlag = "dx" Then 'Strike Delta
...
Public Function EPowerContract(OutPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, i As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EPowerContract = (PowerContract(S + dS, X, T, r, b, v + 0.01, i) - 2 * PowerContract(S, X, T, r, b, v + 0.01, i) + PowerContract(S - dS, X, T, r, b, v + 0.01, i) - PowerContract(S + dS, X, T, r, b, v - 0.01, i) + 2 * PowerContract(S, X, T, r, b, v - 0.01, i) - PowerContract(S - dS, X, T, r, b, v - 0.01, i)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EPowerContract = 1 / (4 * dS * 0.01) * (PowerContract(S + dS, X, T, r, b, v + 0.01, i) - PowerContract(S + dS, X, T, r, b, v - 0.01, i) - PowerContract(S - dS, X, T, r, b, v + 0.01, i) + PowerContract(S - dS, X, T, r, b, v - 0.01, i)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        EPowerContract = (PowerContract(S, X, T, r, b + 0.01, v, i) - PowerContract(S, X, T, r, b - 0.01, v, i)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        EPowerContract = 1 / dS ^ 3 * (PowerContract(S + 2 * dS, X, T, r, b, v, i) - 3 * PowerContract(S + dS, X, T, r, b, v, i) + 3 * PowerContract(S, X, T, r, b, v, i) - PowerContract(S - dS, X, T, r, b, v, i))
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
...
Public Function EPoweredOption(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, i As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EPoweredOption = (PoweredOption(CallPutFlag, S + dS, X, T, r, b, v + 0.01, i) - 2 * PoweredOption(CallPutFlag, S, X, T, r, b, v + 0.01, i) + PoweredOption(CallPutFlag, S - dS, X, T, r, b, v + 0.01, i) - PoweredOption(CallPutFlag, S + dS, X, T, r, b, v - 0.01, i) + 2 * PoweredOption(CallPutFlag, S, X, T, r, b, v - 0.01, i) - PoweredOption(CallPutFlag, S - dS, X, T, r, b, v - 0.01, i)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EPoweredOption = 1 / (4 * dS * 0.01) * (PoweredOption(CallPutFlag, S + dS, X, T, r, b, v + 0.01, i) - PoweredOption(CallPutFlag, S + dS, X, T, r, b, v - 0.01, i) - PoweredOption(CallPutFlag, S - dS, X, T, r, b, v + 0.01, i) + PoweredOption(CallPutFlag, S - dS, X, T, r, b, v - 0.01, i)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        EPoweredOption = (PoweredOption(CallPutFlag, S, X, T, r, b + 0.01, v, i) - PoweredOption(CallPutFlag, S, X, T, r, b - 0.01, v, i)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        EPoweredOption = 1 / dS ^ 3 * (PoweredOption(CallPutFlag, S + 2 * dS, X, T, r, b, v, i) - 3 * PoweredOption(CallPutFlag, S + dS, X, T, r, b, v, i) + 3 * PoweredOption(CallPutFlag, S, X, T, r, b, v, i) - PoweredOption(CallPutFlag, S - dS, X, T, r, b, v, i))
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
...
Public Function PoweredOption(CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, i As Double) As Double
...
Public Function PowerOptionAsymmetric(CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, i As Double) As Double
...
Public Function EPowerOptionAsymmetric(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, i As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EPowerOptionAsymmetric = (PowerOptionAsymmetric(CallPutFlag, S + dS, X, T, r, b, v + 0.01, i) - 2 * PowerOptionAsymmetric(CallPutFlag, S, X, T, r, b, v + 0.01, i) + PowerOptionAsymmetric(CallPutFlag, S - dS, X, T, r, b, v + 0.01, i) - PowerOptionAsymmetric(CallPutFlag, S + dS, X, T, r, b, v - 0.01, i) + 2 * PowerOptionAsymmetric(CallPutFlag, S, X, T, r, b, v - 0.01, i) - PowerOptionAsymmetric(CallPutFlag, S - dS, X, T, r, b, v - 0.01, i)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EPowerOptionAsymmetric = 1 / (4 * dS * 0.01) * (PowerOptionAsymmetric(CallPutFlag, S + dS, X, T, r, b, v + 0.01, i) - PowerOptionAsymmetric(CallPutFlag, S + dS, X, T, r, b, v - 0.01, i) - PowerOptionAsymmetric(CallPutFlag, S - dS, X, T, r, b, v + 0.01, i) + PowerOptionAsymmetric(CallPutFlag, S - dS, X, T, r, b, v - 0.01, i)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        EPowerOptionAsymmetric = (PowerOptionAsymmetric(CallPutFlag, S, X, T, r, b + 0.01, v, i) - PowerOptionAsymmetric(CallPutFlag, S, X, T, r, b - 0.01, v, i)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        EPowerOptionAsymmetric = 1 / dS ^ 3 * (PowerOptionAsymmetric(CallPutFlag, S + 2 * dS, X, T, r, b, v, i) - 3 * PowerOptionAsymmetric(CallPutFlag, S + dS, X, T, r, b, v, i) + 3 * PowerOptionAsymmetric(CallPutFlag, S, X, T, r, b, v, i) - PowerOptionAsymmetric(CallPutFlag, S - dS, X, T, r, b, v, i))
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
