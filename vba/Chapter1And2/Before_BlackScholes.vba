...
Public Function Bachelier(CallPutFlag As String, S As Double, x As Double, T As Double, v As Double) As Double
...
Public Function EBachelier(OutPutFlag As String, CallPutFlag As String, S As Double, x As Double, T As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EBachelier = (Bachelier(CallPutFlag, S + dS, x, T, v + 0.01) - 2 * Bachelier(CallPutFlag, S, x, T, v + 0.01) + Bachelier(CallPutFlag, S - dS, x, T, v + 0.01) - Bachelier(CallPutFlag, S + dS, x, T, v - 0.01) + 2 * Bachelier(CallPutFlag, S, x, T, v - 0.01) - Bachelier(CallPutFlag, S - dS, x, T, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EBachelier = 1 / (4 * dS * 0.01) * (Bachelier(CallPutFlag, S + dS, x, T, v + 0.01) - Bachelier(CallPutFlag, S + dS, x, T, v - 0.01) - Bachelier(CallPutFlag, S - dS, x, T, v + 0.01) + Bachelier(CallPutFlag, S - dS, x, T, v - 0.01)) / 100
    ...
    ElseIf OutPutFlag = "s" Then 'Speed
        EBachelier = 1 / dS ^ 3 * (Bachelier(CallPutFlag, S + 2 * dS, x, T, v) - 3 * Bachelier(CallPutFlag, S + dS, x, T, v) + 3 * Bachelier(CallPutFlag, S, x, T, v) - Bachelier(CallPutFlag, S - dS, x, T, v))
...
Public Function BachelierModified(CallPutFlag As String, S As Double, x , T As Double, r As Double, v As Double) As Double
...
Public Function EBachelierModified(OutPutFlag As String, CallPutFlag As String, S As Double, x As Double, T As Double, r As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EBachelierModified = (BachelierModified(CallPutFlag, S + dS, x, T, r, v + 0.01) - 2 * BachelierModified(CallPutFlag, S, x, T, r, v + 0.01) + BachelierModified(CallPutFlag, S - dS, x, T, r, v + 0.01) - BachelierModified(CallPutFlag, S + dS, x, T, r, v - 0.01) + 2 * BachelierModified(CallPutFlag, S, x, T, r, v - 0.01) - BachelierModified(CallPutFlag, S - dS, x, T, r, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EBachelierModified = 1 / (4 * dS * 0.01) * (BachelierModified(CallPutFlag, S + dS, x, T, r, v + 0.01) - BachelierModified(CallPutFlag, S + dS, x, T, r, v - 0.01) - BachelierModified(CallPutFlag, S - dS, x, T, r, v + 0.01) + BachelierModified(CallPutFlag, S - dS, x, T, r, v - 0.01)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "s" Then 'Speed
        EBachelierModified = 1 / dS ^ 3 * (BachelierModified(CallPutFlag, S + 2 * dS, x, T, r, v) - 3 * BachelierModified(CallPutFlag, S + dS, x, T, r, v) + 3 * BachelierModified(CallPutFlag, S, x, T, r, v) - BachelierModified(CallPutFlag, S - dS, x, T, r, v))
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
...
Public Function Sprenkle(CallPutFlag As String, S As Double, x, T As Double, rho As Double, k As Double, v As Double) As Double
...
Public Function ESprenkle(OutPutFlag As String, CallPutFlag As String, S As Double, x As Double, T As Double, rho As Double, k As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        ESprenkle = (Sprenkle(CallPutFlag, S + dS, x, T, rho, k, v + 0.01) - 2 * Sprenkle(CallPutFlag, S, x, T, rho, k, v + 0.01) + Sprenkle(CallPutFlag, S - dS, x, T, rho, k, v + 0.01) - Sprenkle(CallPutFlag, S + dS, x, T, rho, k, v - 0.01) + 2 * Sprenkle(CallPutFlag, S, x, T, rho, k, v - 0.01) - Sprenkle(CallPutFlag, S - dS, x, T, rho, k, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        ESprenkle = 1 / (4 * dS * 0.01) * (Sprenkle(CallPutFlag, S + dS, x, T, rho, k, v + 0.01) - Sprenkle(CallPutFlag, S + dS, x, T, rho, k, v - 0.01) - Sprenkle(CallPutFlag, S - dS, x, T, rho, k, v + 0.01) + Sprenkle(CallPutFlag, S - dS, x, T, rho, k, v - 0.01)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "s" Then 'Speed
        ESprenkle = 1 / dS ^ 3 * (Sprenkle(CallPutFlag, S + 2 * dS, x, T, rho, k, v) - 3 * Sprenkle(CallPutFlag, S + dS, x, T, rho, k, v) + 3 * Sprenkle(CallPutFlag, S, x, T, rho, k, v) - Sprenkle(CallPutFlag, S - dS, x, T, rho, k, v))
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
