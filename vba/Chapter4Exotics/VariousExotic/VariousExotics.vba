...
Public Function FadeInOption(CallPutFlag As String, S As Double, X As Double, L As Double, H As Double, T As Double, r As Double, b As Double, v As Double, n As Double) As Double
    ...
    For i = 1 To n
        ...
        If CallPutFlag = "c" Then
            sum = sum + S * Exp((b - r) * T) * (CBND(-d5, d1, -rho) - CBND(-d3, d1, -rho)) - X * Exp(-r * T) * (CBND(-d6, d2, -rho) - CBND(-d4, d2, -rho))
        ElseIf CallPutFlag = "p" Then
            sum = sum + X * Exp(-r * T) * (CBND(-d6, -d2, rho) - CBND(-d4, -d2, rho)) - S * Exp((b - r) * T) * (CBND(-d5, -d1, rho) - CBND(-d3, -d1, rho))
        End If
    Next
...
Public Function EExecutive(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, lambda As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EExecutive = (Executive(CallPutFlag, S + dS, X, T, r, b, v + 0.01, lambda) - 2 * Executive(CallPutFlag, S, X, T, r, b, v + 0.01, lambda) + Executive(CallPutFlag, S - dS, X, T, r, b, v + 0.01, lambda) - Executive(CallPutFlag, S + dS, X, T, r, b, v - 0.01, lambda) + 2 * Executive(CallPutFlag, S, X, T, r, b, v - 0.01, lambda) - Executive(CallPutFlag, S - dS, X, T, r, b, v - 0.01, lambda)) / (2 * 0.01 * dS ^ 2) / 100
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EExecutive = 1 / (4 * dS * 0.01) * (Executive(CallPutFlag, S + dS, X, T, r, b, v + 0.01, lambda) - Executive(CallPutFlag, S + dS, X, T, r, b, v - 0.01, lambda) - Executive(CallPutFlag, S - dS, X, T, r, b, v + 0.01, lambda) + Executive(CallPutFlag, S - dS, X, T, r, b, v - 0.01, lambda)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        EExecutive = (Executive(CallPutFlag, S, X, T, r, b + 0.01, v, lambda) - Executive(CallPutFlag, S, X, T, r, b - 0.01, v, lambda)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        EExecutive = 1 / dS ^ 3 * (Executive(CallPutFlag, S + 2 * dS, X, T, r, b, v, lambda) - 3 * Executive(CallPutFlag, S + dS, X, T, r, b, v, lambda) + 3 * Executive(CallPutFlag, S, X, T, r, b, v, lambda) - Executive(CallPutFlag, S - dS, X, T, r, b, v, lambda))
...
Public Function EMoneynessOption(OutPutFlag As String, S As Double, T As Double, r As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EMoneynessOption = (MoneynessOption(S + dS, T, r, v + 0.01) - 2 * MoneynessOption(S, T, r, v + 0.01) + MoneynessOption(S - dS, T, r, v + 0.01) - MoneynessOption(S + dS, T, r, v - 0.01) + 2 * MoneynessOption(S, T, r, v - 0.01) - MoneynessOption(S - dS, T, r, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EMoneynessOption = 1 / (4 * dS * 0.01) * (MoneynessOption(S + dS, T, r, v + 0.01) - MoneynessOption(S + dS, T, r, v - 0.01) - MoneynessOption(S - dS, T, r, v + 0.01) + MoneynessOption(S - dS, T, r, v - 0.01)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "fr" Then 'Futures options rho
        EMoneynessOption = (MoneynessOption(S, T, r + 0.01, v) - MoneynessOption(S, T, r - 0.01, v)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        EMoneynessOption = 1 / dS ^ 3 * (MoneynessOption(S + 2 * dS, T, r, v) - 3 * MoneynessOption(S + dS, T, r, v) + 3 * MoneynessOption(S, T, r, v) - MoneynessOption(S - dS, T, r, v))
    End If
End Function
