...
Public Function RubinsteinSKB(Expansion As String, OutputFLag As String, CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, Skew As Double, Kurt As Double, n As Double) As Variant
