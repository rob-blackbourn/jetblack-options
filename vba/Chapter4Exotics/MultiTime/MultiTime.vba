...
Public Function ForwardStartOption(CallPutFlag As String, S As Double, Alpha As Double, t1 As Double, T As Double, r As Double, b As Double, v As Double) As Double
    ForwardStartOption = S * Exp((b - r) * t1) * GBlackScholes(CallPutFlag, 1, Alpha, T - t1, r, b, v)
End Function

Public Function EForwardStartOption(OutPutFlag As String, CallPutFlag As String, S As Double, Alpha As Double, t1 As Double, T As Double, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EForwardStartOption = (ForwardStartOption(CallPutFlag, S + dS, Alpha, t1, T, r, b, v + 0.01) - 2 * ForwardStartOption(CallPutFlag, S, Alpha, t1, T, r, b, v + 0.01) + ForwardStartOption(CallPutFlag, S - dS, Alpha, t1, T, r, b, v + 0.01) - ForwardStartOption(CallPutFlag, S + dS, Alpha, t1, T, r, b, v - 0.01) + 2 * ForwardStartOption(CallPutFlag, S, Alpha, t1, T, r, b, v - 0.01) - ForwardStartOption(CallPutFlag, S - dS, Alpha, t1, T, r, b, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EForwardStartOption = 1 / (4 * dS * 0.01) * (ForwardStartOption(CallPutFlag, S + dS, Alpha, t1, T, r, b, v + 0.01) - ForwardStartOption(CallPutFlag, S + dS, Alpha, t1, T, r, b, v - 0.01) - ForwardStartOption(CallPutFlag, S - dS, Alpha, t1, T, r, b, v + 0.01) + ForwardStartOption(CallPutFlag, S - dS, Alpha, t1, T, r, b, v - 0.01)) / 100
    ...
    ElseIf OutPutFlag = "s" Then 'Speed
        EForwardStartOption = 1 / dS ^ 3 * (ForwardStartOption(CallPutFlag, S + 2 * dS, Alpha, t1, T, r, b, v) - 3 * ForwardStartOption(CallPutFlag, S + dS, Alpha, t1, T, r, b, v) + 3 * ForwardStartOption(CallPutFlag, S, Alpha, t1, T, r, b, v) - ForwardStartOption(CallPutFlag, S - dS, Alpha, t1, T, r, b, v))
    End If
    
End Function

' Writer extendible options
Public Function ExtendibleWriter(CallPutFlag As String, S As Double, X1 As Double, X2 As Double, t1 As Double, T2 As Double, r As Double, b As Double, v As Double) As Double
...
Public Function EExtendibleWriter(OutPutFlag As String, CallPutFlag As String, S As Double, X1 As Double, X2 As Double, t1 As Double, T2 As Double, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EExtendibleWriter = (ExtendibleWriter(CallPutFlag, S + dS, X1, X2, t1, T2, r, b, v + 0.01) - 2 * ExtendibleWriter(CallPutFlag, S, X1, X2, t1, T2, r, b, v + 0.01) + ExtendibleWriter(CallPutFlag, S - dS, X1, X2, t1, T2, r, b, v + 0.01) - ExtendibleWriter(CallPutFlag, S + dS, X1, X2, t1, T2, r, b, v - 0.01) + 2 * ExtendibleWriter(CallPutFlag, S, X1, X2, t1, T2, r, b, v - 0.01) - ExtendibleWriter(CallPutFlag, S - dS, X1, X2, t1, T2, r, b, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EExtendibleWriter = 1 / (4 * dS * 0.01) * (ExtendibleWriter(CallPutFlag, S + dS, X1, X2, t1, T2, r, b, v + 0.01) - ExtendibleWriter(CallPutFlag, S + dS, X1, X2, t1, T2, r, b, v - 0.01) - ExtendibleWriter(CallPutFlag, S - dS, X1, X2, t1, T2, r, b, v + 0.01) + ExtendibleWriter(CallPutFlag, S - dS, X1, X2, t1, T2, r, b, v - 0.01)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        EExtendibleWriter = (ExtendibleWriter(CallPutFlag, S, X1, X2, t1, T2, r, b + 0.01, v) - ExtendibleWriter(CallPutFlag, S, X1, X2, t1, T2, r, b - 0.01, v)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        EExtendibleWriter = 1 / dS ^ 3 * (ExtendibleWriter(CallPutFlag, S + 2 * dS, X1, X2, t1, T2, r, b, v) - 3 * ExtendibleWriter(CallPutFlag, S + dS, X1, X2, t1, T2, r, b, v) + 3 * ExtendibleWriter(CallPutFlag, S, X1, X2, t1, T2, r, b, v) - ExtendibleWriter(CallPutFlag, S - dS, X1, X2, t1, T2, r, b, v))
    End If
End Function

' Reset Strike Option Type 1
Public Function ResetOptionGrayWhaleyT1(CallPutFlag As String, S As Double, X As Double, tau As Double, T As Double, r As Double, b As Double, v As Double) As Double
    ...
    If CallPutFlag = "c" Then
        ResetOptionGrayWhaleyT1 = Exp((b - r) * (T - tau)) * CND(-a2) * CND(z1) * Exp(-r * tau) - Exp(-r * T) * CND(-a2) * CND(z2) - Exp(-r * T) * CBND(a2, y2, rho) + (S / X) * Exp((b - r) * T) * CBND(a1, y1, rho)
    ElseIf CallPutFlag = "p" Then
        ResetOptionGrayWhaleyT1 = Exp(-r * T) * CND(a2) * CND(-z2) - Exp((b - r) * (T - tau)) * CND(a2) * CND(-z1) * Exp(-r * tau) + Exp(-r * T) * CBND(-a2, -y2, rho) - (S / X) * Exp((b - r) * T) * CBND(-a1, -y1, rho)
    End If

End Function

Public Function EResetOptionGrayWhaleyT1(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, tau As Double, T As Double, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EResetOptionGrayWhaleyT1 = 1 / (4 * dS * 0.01) * (ResetOptionGrayWhaleyT1(CallPutFlag, S + dS, X, tau, T, r, b, v + 0.01) - ResetOptionGrayWhaleyT1(CallPutFlag, S + dS, X, tau, T, r, b, v - 0.01) - ResetOptionGrayWhaleyT1(CallPutFlag, S - dS, X, tau, T, r, b, v + 0.01) + ResetOptionGrayWhaleyT1(CallPutFlag, S - dS, X, tau, T, r, b, v - 0.01)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        EResetOptionGrayWhaleyT1 = (ResetOptionGrayWhaleyT1(CallPutFlag, S, X, tau, T, r, b + 0.01, v) - ResetOptionGrayWhaleyT1(CallPutFlag, S, X, tau, T, r, b - 0.01, v)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        EResetOptionGrayWhaleyT1 = 1 / dS ^ 3 * (ResetOptionGrayWhaleyT1(CallPutFlag, S + 2 * dS, X, tau, T, r, b, v) - 3 * ResetOptionGrayWhaleyT1(CallPutFlag, S + dS, X, tau, T, r, b, v) + 3 * ResetOptionGrayWhaleyT1(CallPutFlag, S, X, tau, T, r, b, v) - ResetOptionGrayWhaleyT1(CallPutFlag, S - dS, X, tau, T, r, b, v))
...
Public Function ResetOptionGrayWhaley(CallPutFlag As String, S As Double, X As Double, tau As Double, T As Double, r As Double, b As Double, v As Double) As Double
    ...
    If CallPutFlag = "c" Then
        ResetOptionGrayWhaley = S * Exp((b - r) * T) * CBND(a1, y1, rho) - X * Exp(-r * T) * CBND(a2, y2, rho) - S * Exp((b - r) * tau) * CND(-a1) * CND(z2) * Exp(-r * (T - tau)) + S * Exp((b - r) * T) * CND(-a1) * CND(z1)
    ElseIf CallPutFlag = "p" Then
        ResetOptionGrayWhaley = S * Exp((b - r) * tau) * CND(a1) * CND(-z2) * Exp(-r * (T - tau)) - S * Exp((b - r) * T) * CND(a1) * CND(-z1) + X * Exp(-r * T) * CBND(-a2, -y2, rho) - S * Exp((b - r) * T) * CBND(-a1, -y1, rho)
    End If
End Function

Public Function EResetOptionGrayWhaley(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, tau As Double, T As Double, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EResetOptionGrayWhaley = (ResetOptionGrayWhaley(CallPutFlag, S + dS, X, tau, T, r, b, v + 0.01) - 2 * ResetOptionGrayWhaley(CallPutFlag, S, X, tau, T, r, b, v + 0.01) + ResetOptionGrayWhaley(CallPutFlag, S - dS, X, tau, T, r, b, v + 0.01) - ResetOptionGrayWhaley(CallPutFlag, S + dS, X, tau, T, r, b, v - 0.01) + 2 * ResetOptionGrayWhaley(CallPutFlag, S, X, tau, T, r, b, v - 0.01) - ResetOptionGrayWhaley(CallPutFlag, S - dS, X, tau, T, r, b, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EResetOptionGrayWhaley = 1 / (4 * dS * 0.01) * (ResetOptionGrayWhaley(CallPutFlag, S + dS, X, tau, T, r, b, v + 0.01) - ResetOptionGrayWhaley(CallPutFlag, S + dS, X, tau, T, r, b, v - 0.01) - ResetOptionGrayWhaley(CallPutFlag, S - dS, X, tau, T, r, b, v + 0.01) + ResetOptionGrayWhaley(CallPutFlag, S - dS, X, tau, T, r, b, v - 0.01)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        EResetOptionGrayWhaley = (ResetOptionGrayWhaley(CallPutFlag, S, X, tau, T, r, b + 0.01, v) - ResetOptionGrayWhaley(CallPutFlag, S, X, tau, T, r, b - 0.01, v)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        EResetOptionGrayWhaley = 1 / dS ^ 3 * (ResetOptionGrayWhaley(CallPutFlag, S + 2 * dS, X, tau, T, r, b, v) - 3 * ResetOptionGrayWhaley(CallPutFlag, S + dS, X, tau, T, r, b, v) + 3 * ResetOptionGrayWhaley(CallPutFlag, S, X, tau, T, r, b, v) - ResetOptionGrayWhaley(CallPutFlag, S - dS, X, tau, T, r, b, v))
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
...
' Options on options
Public Function OptionsOnOptions(TypeFlag As String, S As Double, X1 As Double, X2 As Double, t1 As Double, T2 As Double, r As Double, b As Double, v As Double) As Double
...
Private Function CriticalValueOptionsOnOptions(CallPutFlag As String, X1 As Double, X2 As Double, T As Double, r As Double, b As Double, v As Double) As Double
...
Public Function EOptionsOnOptions(OutPutFlag As String, CallPutFlag As String, S As Double, X1 As Double, X2 As Double, t1 As Double, T2 As Double, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EOptionsOnOptions = (OptionsOnOptions(CallPutFlag, S + dS, X1, X2, t1, T2, r, b, v + 0.01) - 2 * OptionsOnOptions(CallPutFlag, S, X1, X2, t1, T2, r, b, v + 0.01) + OptionsOnOptions(CallPutFlag, S - dS, X1, X2, t1, T2, r, b, v + 0.01) - OptionsOnOptions(CallPutFlag, S + dS, X1, X2, t1, T2, r, b, v - 0.01) + 2 * OptionsOnOptions(CallPutFlag, S, X1, X2, t1, T2, r, b, v - 0.01) - OptionsOnOptions(CallPutFlag, S - dS, X1, X2, t1, T2, r, b, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EOptionsOnOptions = 1 / (4 * dS * 0.01) * (OptionsOnOptions(CallPutFlag, S + dS, X1, X2, t1, T2, r, b, v + 0.01) - OptionsOnOptions(CallPutFlag, S + dS, X1, X2, t1, T2, r, b, v - 0.01) - OptionsOnOptions(CallPutFlag, S - dS, X1, X2, t1, T2, r, b, v + 0.01) + OptionsOnOptions(CallPutFlag, S - dS, X1, X2, t1, T2, r, b, v - 0.01)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        EOptionsOnOptions = (OptionsOnOptions(CallPutFlag, S, X1, X2, t1, T2, r, b + 0.01, v) - OptionsOnOptions(CallPutFlag, S, X1, X2, t1, T2, r, b - 0.01, v)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        EOptionsOnOptions = 1 / dS ^ 3 * (OptionsOnOptions(CallPutFlag, S + 2 * dS, X1, X2, t1, T2, r, b, v) - 3 * OptionsOnOptions(CallPutFlag, S + dS, X1, X2, t1, T2, r, b, v) + 3 * OptionsOnOptions(CallPutFlag, S, X1, X2, t1, T2, r, b, v) - OptionsOnOptions(CallPutFlag, S - dS, X1, X2, t1, T2, r, b, v))
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
...
Public Function SimpleChooser(S As Double, X As Double, t1 As Double, T2 As Double, r As Double, b As Double, v As Double) As Double
    ...
    SimpleChooser = S * Exp((b - r) * T2) * CND(d) - X * Exp(-r * T2) * CND(d - v * Sqr(T2)) - S * Exp((b - r) * T2) * CND(-y) + X * Exp(-r * T2) * CND(-y + v * Sqr(t1))
End Function

Public Function ESimpleChooser(OutPutFlag As String, S As Double, X As Double, t1 As Double, T2 As Double, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        ESimpleChooser = (SimpleChooser(S + dS, X, t1, T2, r, b, v + 0.01) - 2 * SimpleChooser(S, X, t1, T2, r, b, v + 0.01) + SimpleChooser(S - dS, X, t1, T2, r, b, v + 0.01) - SimpleChooser(S + dS, X, t1, T2, r, b, v - 0.01) + 2 * SimpleChooser(S, X, t1, T2, r, b, v - 0.01) - SimpleChooser(S - dS, X, t1, T2, r, b, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        ESimpleChooser = 1 / (4 * dS * 0.01) * (SimpleChooser(S + dS, X, t1, T2, r, b, v + 0.01) - SimpleChooser(S + dS, X, t1, T2, r, b, v - 0.01) - SimpleChooser(S - dS, X, t1, T2, r, b, v + 0.01) + SimpleChooser(S - dS, X, t1, T2, r, b, v - 0.01)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        ESimpleChooser = (SimpleChooser(S, X, t1, T2, r, b + 0.01, v) - SimpleChooser(S, X, t1, T2, r, b - 0.01, v)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        ESimpleChooser = 1 / dS ^ 3 * (SimpleChooser(S + 2 * dS, X, t1, T2, r, b, v) - 3 * SimpleChooser(S + dS, X, t1, T2, r, b, v) + 3 * SimpleChooser(S, X, t1, T2, r, b, v) - SimpleChooser(S - dS, X, t1, T2, r, b, v))
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
...
Public Function ComplexChooser(S As Double, Xc As Double, Xp As Double, T As Double, Tc As Double, Tp As Double, r As Double, b As Double, v As Double) As Double
...
Private Function CriticalValueChooser(S As Double, Xc As Double, Xp As Double, T As Double, Tc As Double, Tp As Double, r As Double, b As Double, v As Double) As Double
...
Public Function EComplexChooser(OutPutFlag As String, S As Double, Xc As Double, Xp As Double, T As Double, Tc As Double, Tp As Double, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EComplexChooser = (ComplexChooser(S + dS, Xc, Xp, T, Tc, Tp, r, b, v + 0.01) - 2 * ComplexChooser(S, Xc, Xp, T, Tc, Tp, r, b, v + 0.01) + ComplexChooser(S - dS, Xc, Xp, T, Tc, Tp, r, b, v + 0.01) - ComplexChooser(S + dS, Xc, Xp, T, Tc, Tp, r, b, v - 0.01) + 2 * ComplexChooser(S, Xc, Xp, T, Tc, Tp, r, b, v - 0.01) - ComplexChooser(S - dS, Xc, Xp, T, Tc, Tp, r, b, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EComplexChooser = 1 / (4 * dS * 0.01) * (ComplexChooser(S + dS, Xc, Xp, T, Tc, Tp, r, b, v + 0.01) - ComplexChooser(S + dS, Xc, Xp, T, Tc, Tp, r, b, v - 0.01) - ComplexChooser(S - dS, Xc, Xp, T, Tc, Tp, r, b, v + 0.01) + ComplexChooser(S - dS, Xc, Xp, T, Tc, Tp, r, b, v - 0.01)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        EComplexChooser = (ComplexChooser(S, Xc, Xp, T, Tc, Tp, r, b + 0.01, v) - ComplexChooser(S, Xc, Xp, T, Tc, Tp, r, b - 0.01, v)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        EComplexChooser = 1 / dS ^ 3 * (ComplexChooser(S + 2 * dS, Xc, Xp, T, Tc, Tp, r, b, v) - 3 * ComplexChooser(S + dS, Xc, Xp, T, Tc, Tp, r, b, v) + 3 * ComplexChooser(S, Xc, Xp, T, Tc, Tp, r, b, v) - ComplexChooser(S - dS, Xc, Xp, T, Tc, Tp, r, b, v))
    End If
End Function
