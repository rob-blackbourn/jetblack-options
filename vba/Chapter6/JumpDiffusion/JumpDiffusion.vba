...
Public Function JumpDiffusionBates(CallPutFlag As String, S As Double, x As Double, T As Double, r As Double, b As Double, v As Double, lambda As Double, avgk As Double, delta As Double) As Double
...
Public Function EJumpDiffusionBates(OutPutFlag As String, CallPutFlag As String, S As Double, x As Double, T As Double, r As Double, b As Double, v As Double, lambda As Double, avgk As Double, delta As Double, Optional dS)
...
Public Function JumpDiffusionMerton(CallPutFlag As String, S As Double, x As Double, T As Double, r As Double, v As Double, lambda As Double, gamma As Double) As Double
...
Public Function EJumpDiffusionMerton(OutPutFlag As String, CallPutFlag As String, S As Double, x As Double, T As Double, r As Double, v As Double, lambda As Double, gamma As Double, Optional dS)
