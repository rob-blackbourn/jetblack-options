...
Public Function TrinomialTree(OutputFLag As String, AmeEurFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, n As Integer) As Variant
    ...
    For j = n - 1 To 0 Step -1
        ...
        For i = 0 To (j * 2)
            ...
            If AmeEurFlag = "a" Then
                OptionValue(i) = Max(z * (S * u ^ Max(i - j, 0) * d ^ Max(j - i, 0) - X), OptionValue(i))
            End If
        Next
        If j = 1 Then
            ReturnValue(1) = (OptionValue(2) - OptionValue(0)) / (S * u - S * d)
            ReturnValue(2) = ((OptionValue(2) - OptionValue(1)) / (S * u - S) - (OptionValue(1) - OptionValue(0)) / (S - S * d)) / (0.5 * (S * u - S * d))
...
Public Function CRRBinomial(OutputFLag As String, AmeEurFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, n As Integer) As Variant
...
Public Function LeisenReimerBinomial(OutputFLag As String, AmeEurFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, n As Integer) As Variant
...
Public Function JarrowRuddBinomial(OutputFLag As String, AmeEurFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, n As Integer) As Variant
    ...
    For j = n - 1 To 0 Step -1:
        For i = 0 To j
            If AmeEurFlag = "e" Then
                OptionValue(i) = (p * OptionValue(i + 1) + (1 - p) * OptionValue(i)) * Df
            ElseIf AmeEurFlag = "a" Then
                OptionValue(i) = Max((z * (S * u ^ i * d ^ (j - i) - X)), (p * OptionValue(i + 1) + (1 - p) * OptionValue(i)) * Df)
            End If
        Next
        If j = 2 Then
            ReturnValue(2) = ((OptionValue(2) - OptionValue(1)) / (S * u ^ 2 - S * u * d) _
