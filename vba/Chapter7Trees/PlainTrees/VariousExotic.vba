...
Public Function BinomialCompoundOption(OutputFLag As String, CompoundEurAmeFlag As String, AmeEurFlag As String, CompoundTypeFlag As String, S As Double, X1 As Double, X2 As Double, t1 As Double, T2 As Double, r As Double, b As Double, v As Double, n As Integer) As Variant
...
' Cox-Ross-Rubinstein binomial tree
Public Function BinomialCompoundExoticOption(OutputFLag As String, AmeEurFlag As String, TypeFlag As String, UnderlyingOptionType As Integer, S As Double, X1 As Double, X2 As Double, t1 As Double, T2 As Double, r As Double, b As Double, v As Double, pow As Double, cap As Double, n As Integer) As Variant
