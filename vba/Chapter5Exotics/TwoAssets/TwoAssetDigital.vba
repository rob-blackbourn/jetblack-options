...
Public Function TwoAssetCashOrNothing(TypeFlag As Integer, S1 As Double, S2 As Double, X1 As Double, X2 As Double, k As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double) As Double
...
Public Function ETwoAssetCashOrNothing(OutPutFlag As String, TypeFlag As Integer, S1 As Double, S2 As Double, X1 As Double, X2 As Double, k As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv1" Then 'DGammaDVol S1
        ETwoAssetCashOrNothing = (TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2, X1, X2, k, T, r, b1, b2, v1 + dv, v2, rho) - 2 * TwoAssetCashOrNothing(TypeFlag, S1, S2, X1, X2, k, T, r, b1, b2, v1 + dv, v2, rho) + TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2, X1, X2, k, T, r, b1, b2, v1 + dv, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2, X1, X2, k, T, r, b1, b2, v1 - dv, v2, rho) + 2 * TwoAssetCashOrNothing(TypeFlag, S1, S2, X1, X2, k, T, r, b1, b2, v1 - dv, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2, X1, X2, k, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gv2" Then 'DGammaDVol S2
        ETwoAssetCashOrNothing = (TwoAssetCashOrNothing(TypeFlag, S1, S2 + dS, X1, X2, k, T, r, b1, b2, v1, v2 + dv, rho) - 2 * TwoAssetCashOrNothing(TypeFlag, S1, S2, X1, X2, k, T, r, b1, b2, v1, v2 + dv, rho) + TwoAssetCashOrNothing(TypeFlag, S1, S2 - dS, X1, X2, k, T, r, b1, b2, v1, v2 + dv, rho) - TwoAssetCashOrNothing(TypeFlag, S1, S2 + dS, X1, X2, k, T, r, b1, b2, v1, v2 - dv, rho) + 2 * TwoAssetCashOrNothing(TypeFlag, S1, S2, X1, X2, k, T, r, b1, b2, v1, v2 - dv, rho) - TwoAssetCashOrNothing(TypeFlag, S1, S2 - dS, X1, X2, k, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv1" Then 'Cross GammaDvol S1v2 Cross Zomma
        ETwoAssetCashOrNothing = (TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2, X1, X2, k, T, r, b1, b2, v1, v2 + dv, rho) - 2 * TwoAssetCashOrNothing(TypeFlag, S1, S2, X1, X2, k, T, r, b1, b2, v1, v2 + dv, rho) + TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2, X1, X2, k, T, r, b1, b2, v1, v2 + dv, rho) - TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2, X1, X2, k, T, r, b1, b2, v1, v2 - dv, rho) + 2 * TwoAssetCashOrNothing(TypeFlag, S1, S2, X1, X2, k, T, r, b1, b2, v1, v2 - dv, rho) - TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2, X1, X2, k, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv2" Then 'Cross GammaDvol S2v1 Cross Zomma
        ETwoAssetCashOrNothing = (TwoAssetCashOrNothing(TypeFlag, S1, S2 + dS, X1, X2, k, T, r, b1, b2, v1 + dv, v2, rho) - 2 * TwoAssetCashOrNothing(TypeFlag, S1, S2, X1, X2, k, T, r, b1, b2, v1 + dv, v2, rho) + TwoAssetCashOrNothing(TypeFlag, S1, S2 - dS, X1, X2, k, T, r, b1, b2, v1 + dv, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1, S2 + dS, X1, X2, k, T, r, b1, b2, v1 - dv, v2, rho) + 2 * TwoAssetCashOrNothing(TypeFlag, S1, S2, X1, X2, k, T, r, b1, b2, v1 - dv, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1, S2 - dS, X1, X2, k, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ...
    ElseIf OutPutFlag = "cg" Then 'Cross gamma
        ETwoAssetCashOrNothing = 1 / (4 * dS * dS) * (TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2 + dS, X1, X2, k, T, r, b1, b2, v1, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2 - dS, X1, X2, k, T, r, b1, b2, v1, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2 + dS, X1, X2, k, T, r, b1, b2, v1, v2, rho) + TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2 - dS, X1, X2, k, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "dddv1" Then 'DDeltaDvol S1 v1
        ETwoAssetCashOrNothing = 1 / (4 * dS * dv) * (TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2, X1, X2, k, T, r, b1, b2, v1 + dv, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2, X1, X2, k, T, r, b1, b2, v1 - dv, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2, X1, X2, k, T, r, b1, b2, v1 + dv, v2, rho) + TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2, X1, X2, k, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "dddv2" Then 'DDeltaDvol S2 v2
        ETwoAssetCashOrNothing = 1 / (4 * dS * dv) * (TwoAssetCashOrNothing(TypeFlag, S1, S2 + dS, X1, X2, k, T, r, b1, b2, v1, v2 + dv, rho) - TwoAssetCashOrNothing(TypeFlag, S1, S2 + dS, X1, X2, k, T, r, b1, b2, v1, v2 - dv, rho) - TwoAssetCashOrNothing(TypeFlag, S1, S2 - dS, X1, X2, k, T, r, b1, b2, v1, v2 + dv, rho) + TwoAssetCashOrNothing(TypeFlag, S1, S2 - dS, X1, X2, k, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv1" Then 'Cross vanna 1
        ETwoAssetCashOrNothing = 1 / (4 * dS * dv) * (TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2, X1, X2, k, T, r, b1, b2, v1, v2 + dv, rho) - TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2, X1, X2, k, T, r, b1, b2, v1, v2 - dv, rho) - TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2, X1, X2, k, T, r, b1, b2, v1, v2 + dv, rho) + TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2, X1, X2, k, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv2" Then 'Cross vanna 2
        ETwoAssetCashOrNothing = 1 / (4 * dS * dv) * (TwoAssetCashOrNothing(TypeFlag, S1, S2 + dS, X1, X2, k, T, r, b1, b2, v1 + dv, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1, S2 + dS, X1, X2, k, T, r, b1, b2, v1 - dv, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1, S2 - dS, X1, X2, k, T, r, b1, b2, v1 + dv, v2, rho) + TwoAssetCashOrNothing(TypeFlag, S1, S2 - dS, X1, X2, k, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ...
    ElseIf OutPutFlag = "cv" Then 'Cross vomma
        ETwoAssetCashOrNothing = 1 / (4 * dv * dv) * (TwoAssetCashOrNothing(TypeFlag, S1, S2, X1, X2, k, T, r, b1, b2, v1 + dv, v2 + dv, rho) - TwoAssetCashOrNothing(TypeFlag, S1, S2, X1, X2, k, T, r, b1, b2, v1 - dv, v2 + dv, rho) - TwoAssetCashOrNothing(TypeFlag, S1, S2, X1, X2, k, T, r, b1, b2, v1 + dv, v2 - dv, rho) + TwoAssetCashOrNothing(TypeFlag, S1, S2, X1, X2, k, T, r, b1, b2, v1 - dv, v2 - dv, rho)) / 10000
    ...
    ElseIf OutPutFlag = "s1" Then 'Speed S1
        ETwoAssetCashOrNothing = 1 / dS ^ 3 * (TwoAssetCashOrNothing(TypeFlag, S1 + 2 * dS, S2, X1, X2, k, T, r, b1, b2, v1, v2, rho) - 3 * TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2, X1, X2, k, T, r, b1, b2, v1, v2, rho) + 3 * TwoAssetCashOrNothing(TypeFlag, S1, S2, X1, X2, k, T, r, b1, b2, v1, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2, X1, X2, k, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "s2" Then 'Speed S2
        ETwoAssetCashOrNothing = 1 / dS ^ 3 * (TwoAssetCashOrNothing(TypeFlag, S1, S2 + 2 * dS, X1, X2, k, T, r, b1, b2, v1, v2, rho) - 3 * TwoAssetCashOrNothing(TypeFlag, S1, S2 + dS, X1, X2, k, T, r, b1, b2, v1, v2, rho) + 3 * TwoAssetCashOrNothing(TypeFlag, S1, S2, X1, X2, k, T, r, b1, b2, v1, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1, S2 - dS, X1, X2, k, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "cs1" Then 'Cross speed S1^2S2
        ETwoAssetCashOrNothing = (TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2 + dS, X1, X2, k, T, r, b1, b2, v1, v2, rho) - 2 * TwoAssetCashOrNothing(TypeFlag, S1, S2 + dS, X1, X2, k, T, r, b1, b2, v1, v2, rho) + TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2 + dS, X1, X2, k, T, r, b1, b2, v1, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2 - dS, X1, X2, k, T, r, b1, b2, v1, v2, rho) + 2 * TwoAssetCashOrNothing(TypeFlag, S1, S2 - dS, X1, X2, k, T, r, b1, b2, v1, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2 - dS, X1, X2, k, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "cs2" Then 'Cross speed S2^2S1
        ETwoAssetCashOrNothing = (TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2 + dS, X1, X2, k, T, r, b1, b2, v1, v2, rho) - 2 * TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2, X1, X2, k, T, r, b1, b2, v1, v2, rho) + TwoAssetCashOrNothing(TypeFlag, S1 + dS, S2 - dS, X1, X2, k, T, r, b1, b2, v1, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2 + dS, X1, X2, k, T, r, b1, b2, v1, v2, rho) + 2 * TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2, X1, X2, k, T, r, b1, b2, v1, v2, rho) - TwoAssetCashOrNothing(TypeFlag, S1 - dS, S2 - dS, X1, X2, k, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
...
Public Function EBestOfTwoAssetsDigital(OutPutFlag As String, TypeFlag As String, S1 As Double, S2 As Double, X As Double, k As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv1" Then 'DGammaDVol S1
        EBestOfTwoAssetsDigital = (BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2, X, k, T, r, b1, b2, v1 + dv, v2, rho) - 2 * BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2, v1 + dv, v2, rho) + BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2, X, k, T, r, b1, b2, v1 + dv, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2, X, k, T, r, b1, b2, v1 - dv, v2, rho) + 2 * BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2, v1 - dv, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2, X, k, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gv2" Then 'DGammaDVol S2
        EBestOfTwoAssetsDigital = (BestOfTwoAssetsDigital(TypeFlag, S1, S2 + dS, X, k, T, r, b1, b2, v1, v2 + dv, rho) - 2 * BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2, v1, v2 + dv, rho) + BestOfTwoAssetsDigital(TypeFlag, S1, S2 - dS, X, k, T, r, b1, b2, v1, v2 + dv, rho) - BestOfTwoAssetsDigital(TypeFlag, S1, S2 + dS, X, k, T, r, b1, b2, v1, v2 - dv, rho) + 2 * BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2, v1, v2 - dv, rho) - BestOfTwoAssetsDigital(TypeFlag, S1, S2 - dS, X, k, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv1" Then 'Cross GammaDvol S1v2 Cross Zomma
        EBestOfTwoAssetsDigital = (BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2, X, k, T, r, b1, b2, v1, v2 + dv, rho) - 2 * BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2, v1, v2 + dv, rho) + BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2, X, k, T, r, b1, b2, v1, v2 + dv, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2, X, k, T, r, b1, b2, v1, v2 - dv, rho) + 2 * BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2, v1, v2 - dv, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2, X, k, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv2" Then 'Cross GammaDvol S2v1 Cross Zomma
        EBestOfTwoAssetsDigital = (BestOfTwoAssetsDigital(TypeFlag, S1, S2 + dS, X, k, T, r, b1, b2, v1 + dv, v2, rho) - 2 * BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2, v1 + dv, v2, rho) + BestOfTwoAssetsDigital(TypeFlag, S1, S2 - dS, X, k, T, r, b1, b2, v1 + dv, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1, S2 + dS, X, k, T, r, b1, b2, v1 - dv, v2, rho) + 2 * BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2, v1 - dv, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1, S2 - dS, X, k, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp1" Then 'GammaP S1
    ...
    ElseIf OutPutFlag = "cg" Then 'Cross gamma
        EBestOfTwoAssetsDigital = 1 / (4 * dS * dS) * (BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2 + dS, X, k, T, r, b1, b2, v1, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2 - dS, X, k, T, r, b1, b2, v1, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2 + dS, X, k, T, r, b1, b2, v1, v2, rho) + BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2 - dS, X, k, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "dddv1" Then 'DDeltaDvol S1 v1
        EBestOfTwoAssetsDigital = 1 / (4 * dS * dv) * (BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2, X, k, T, r, b1, b2, v1 + dv, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2, X, k, T, r, b1, b2, v1 - dv, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2, X, k, T, r, b1, b2, v1 + dv, v2, rho) + BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2, X, k, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "dddv2" Then 'DDeltaDvol S2 v2
        EBestOfTwoAssetsDigital = 1 / (4 * dS * dv) * (BestOfTwoAssetsDigital(TypeFlag, S1, S2 + dS, X, k, T, r, b1, b2, v1, v2 + dv, rho) - BestOfTwoAssetsDigital(TypeFlag, S1, S2 + dS, X, k, T, r, b1, b2, v1, v2 - dv, rho) - BestOfTwoAssetsDigital(TypeFlag, S1, S2 - dS, X, k, T, r, b1, b2, v1, v2 + dv, rho) + BestOfTwoAssetsDigital(TypeFlag, S1, S2 - dS, X, k, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv1" Then 'Cross vanna 1
        EBestOfTwoAssetsDigital = 1 / (4 * dS * dv) * (BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2, X, k, T, r, b1, b2, v1, v2 + dv, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2, X, k, T, r, b1, b2, v1, v2 - dv, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2, X, k, T, r, b1, b2, v1, v2 + dv, rho) + BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2, X, k, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv2" Then 'Cross vanna 2
        EBestOfTwoAssetsDigital = 1 / (4 * dS * dv) * (BestOfTwoAssetsDigital(TypeFlag, S1, S2 + dS, X, k, T, r, b1, b2, v1 + dv, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1, S2 + dS, X, k, T, r, b1, b2, v1 - dv, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1, S2 - dS, X, k, T, r, b1, b2, v1 + dv, v2, rho) + BestOfTwoAssetsDigital(TypeFlag, S1, S2 - dS, X, k, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "v1" Then 'Vega v1
    ...
    ElseIf OutPutFlag = "cv" Then 'Cross vomma
        EBestOfTwoAssetsDigital = 1 / (4 * dv * dv) * (BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2, v1 + dv, v2 + dv, rho) - BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2, v1 - dv, v2 + dv, rho) - BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2, v1 + dv, v2 - dv, rho) + BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2, v1 - dv, v2 - dv, rho)) / 10000
    ElseIf OutPutFlag = "vp1" Then 'VegaP v1
    ...
    ElseIf OutPutFlag = "b2" Then 'Carry S2
        EBestOfTwoAssetsDigital = (BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2 + 0.01, v1, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2 - 0.01, v1, v2, rho)) / (2)
    ElseIf OutPutFlag = "s1" Then 'Speed S1
        EBestOfTwoAssetsDigital = 1 / dS ^ 3 * (BestOfTwoAssetsDigital(TypeFlag, S1 + 2 * dS, S2, X, k, T, r, b1, b2, v1, v2, rho) - 3 * BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2, X, k, T, r, b1, b2, v1, v2, rho) + 3 * BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2, v1, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2, X, k, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "s2" Then 'Speed S2
        EBestOfTwoAssetsDigital = 1 / dS ^ 3 * (BestOfTwoAssetsDigital(TypeFlag, S1, S2 + 2 * dS, X, k, T, r, b1, b2, v1, v2, rho) - 3 * BestOfTwoAssetsDigital(TypeFlag, S1, S2 + dS, X, k, T, r, b1, b2, v1, v2, rho) + 3 * BestOfTwoAssetsDigital(TypeFlag, S1, S2, X, k, T, r, b1, b2, v1, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1, S2 - dS, X, k, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "cs1" Then 'Cross speed S1^2S2
        EBestOfTwoAssetsDigital = (BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2 + dS, X, k, T, r, b1, b2, v1, v2, rho) - 2 * BestOfTwoAssetsDigital(TypeFlag, S1, S2 + dS, X, k, T, r, b1, b2, v1, v2, rho) + BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2 + dS, X, k, T, r, b1, b2, v1, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2 - dS, X, k, T, r, b1, b2, v1, v2, rho) + 2 * BestOfTwoAssetsDigital(TypeFlag, S1, S2 - dS, X, k, T, r, b1, b2, v1, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2 - dS, X, k, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "cs2" Then 'Cross speed S2^2S1
        EBestOfTwoAssetsDigital = (BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2 + dS, X, k, T, r, b1, b2, v1, v2, rho) - 2 * BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2, X, k, T, r, b1, b2, v1, v2, rho) + BestOfTwoAssetsDigital(TypeFlag, S1 + dS, S2 - dS, X, k, T, r, b1, b2, v1, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2 + dS, X, k, T, r, b1, b2, v1, v2, rho) + 2 * BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2, X, k, T, r, b1, b2, v1, v2, rho) - BestOfTwoAssetsDigital(TypeFlag, S1 - dS, S2 - dS, X, k, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
