...
Public Function EPartialTimeTwoAssetBarrier(OutPutFlag As String, TypeFlag As String, S1 As Double, S2 As Double, X As Double, H As Double, t1 As Double, T2 As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv1" Then 'DGammaDVol S1
        EPartialTimeTwoAssetBarrier = (PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, t1, T2, r, b1, b2, v1 + dv, v2, rho) - 2 * PartialTimeTwoAssetBarrier(TypeFlag, S1, S2, X, H, t1, T2, r, b1, b2, v1 + dv, v2, rho) + PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, t1, T2, r, b1, b2, v1 + dv, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, t1, T2, r, b1, b2, v1 - dv, v2, rho) + 2 * PartialTimeTwoAssetBarrier(TypeFlag, S1, S2, X, H, t1, T2, r, b1, b2, v1 - dv, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, t1, T2, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gv2" Then 'DGammaDVol S2
        EPartialTimeTwoAssetBarrier = (PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, t1, T2, r, b1, b2, v1, v2 + dv, rho) - 2 * PartialTimeTwoAssetBarrier(TypeFlag, S1, S2, X, H, t1, T2, r, b1, b2, v1, v2 + dv, rho) + PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, t1, T2, r, b1, b2, v1, v2 + dv, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, t1, T2, r, b1, b2, v1, v2 - dv, rho) + 2 * PartialTimeTwoAssetBarrier(TypeFlag, S1, S2, X, H, t1, T2, r, b1, b2, v1, v2 - dv, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, t1, T2, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv1" Then 'Cross GammaDvol S1v2 Cross Zomma
        EPartialTimeTwoAssetBarrier = (PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, t1, T2, r, b1, b2, v1, v2 + dv, rho) - 2 * PartialTimeTwoAssetBarrier(TypeFlag, S1, S2, X, H, t1, T2, r, b1, b2, v1, v2 + dv, rho) + PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, t1, T2, r, b1, b2, v1, v2 + dv, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, t1, T2, r, b1, b2, v1, v2 - dv, rho) + 2 * PartialTimeTwoAssetBarrier(TypeFlag, S1, S2, X, H, t1, T2, r, b1, b2, v1, v2 - dv, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, t1, T2, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv2" Then 'Cross GammaDvol S2v1 Cross Zomma
        EPartialTimeTwoAssetBarrier = (PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, t1, T2, r, b1, b2, v1 + dv, v2, rho) - 2 * PartialTimeTwoAssetBarrier(TypeFlag, S1, S2, X, H, t1, T2, r, b1, b2, v1 + dv, v2, rho) + PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, t1, T2, r, b1, b2, v1 + dv, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, t1, T2, r, b1, b2, v1 - dv, v2, rho) + 2 * PartialTimeTwoAssetBarrier(TypeFlag, S1, S2, X, H, t1, T2, r, b1, b2, v1 - dv, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, t1, T2, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ...
    ElseIf OutPutFlag = "cg" Then 'Cross gamma
        EPartialTimeTwoAssetBarrier = 1 / (4 * dS * dS) * (PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2 + dS, X, H, t1, T2, r, b1, b2, v1, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2 - dS, X, H, t1, T2, r, b1, b2, v1, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2 + dS, X, H, t1, T2, r, b1, b2, v1, v2, rho) + PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2 - dS, X, H, t1, T2, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "dddv1" Then 'DDeltaDvol S1 v1
        EPartialTimeTwoAssetBarrier = 1 / (4 * dS * dv) * (PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, t1, T2, r, b1, b2, v1 + dv, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, t1, T2, r, b1, b2, v1 - dv, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, t1, T2, r, b1, b2, v1 + dv, v2, rho) + PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, t1, T2, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "dddv2" Then 'DDeltaDvol S2 v2
        EPartialTimeTwoAssetBarrier = 1 / (4 * dS * dv) * (PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, t1, T2, r, b1, b2, v1, v2 + dv, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, t1, T2, r, b1, b2, v1, v2 - dv, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, t1, T2, r, b1, b2, v1, v2 + dv, rho) + PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, t1, T2, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv1" Then 'Cross vanna 1
        EPartialTimeTwoAssetBarrier = 1 / (4 * dS * dv) * (PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, t1, T2, r, b1, b2, v1, v2 + dv, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, t1, T2, r, b1, b2, v1, v2 - dv, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, t1, T2, r, b1, b2, v1, v2 + dv, rho) + PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, t1, T2, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv2" Then 'Cross vanna 2
        EPartialTimeTwoAssetBarrier = 1 / (4 * dS * dv) * (PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, t1, T2, r, b1, b2, v1 + dv, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, t1, T2, r, b1, b2, v1 - dv, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, t1, T2, r, b1, b2, v1 + dv, v2, rho) + PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, t1, T2, r, b1, b2, v1 - dv, v2, rho)) / 100
   ...
   ElseIf OutPutFlag = "cv" Then 'Cross vomma
        EPartialTimeTwoAssetBarrier = 1 / (4 * dv * dv) * (PartialTimeTwoAssetBarrier(TypeFlag, S1, S2, X, H, t1, T2, r, b1, b2, v1 + dv, v2 + dv, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1, S2, X, H, t1, T2, r, b1, b2, v1 - dv, v2 + dv, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1, S2, X, H, t1, T2, r, b1, b2, v1 + dv, v2 - dv, rho) + PartialTimeTwoAssetBarrier(TypeFlag, S1, S2, X, H, t1, T2, r, b1, b2, v1 - dv, v2 - dv, rho)) / 10000
   ...
   ElseIf OutPutFlag = "corrcorr" Then 'DrhoDrho
    ...
    ElseIf OutPutFlag = "s1" Then 'Speed S1
        EPartialTimeTwoAssetBarrier = 1 / dS ^ 3 * (PartialTimeTwoAssetBarrier(TypeFlag, S1 + 2 * dS, S2, X, H, t1, T2, r, b1, b2, v1, v2, rho) - 3 * PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, t1, T2, r, b1, b2, v1, v2, rho) + 3 * PartialTimeTwoAssetBarrier(TypeFlag, S1, S2, X, H, t1, T2, r, b1, b2, v1, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, t1, T2, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "s2" Then 'Speed S2
        EPartialTimeTwoAssetBarrier = 1 / dS ^ 3 * (PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 + 2 * dS, X, H, t1, T2, r, b1, b2, v1, v2, rho) - 3 * PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, t1, T2, r, b1, b2, v1, v2, rho) + 3 * PartialTimeTwoAssetBarrier(TypeFlag, S1, S2, X, H, t1, T2, r, b1, b2, v1, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, t1, T2, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "cs1" Then 'Cross speed S1^2S2
        EPartialTimeTwoAssetBarrier = (PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2 + dS, X, H, t1, T2, r, b1, b2, v1, v2, rho) - 2 * PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, t1, T2, r, b1, b2, v1, v2, rho) + PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2 + dS, X, H, t1, T2, r, b1, b2, v1, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2 - dS, X, H, t1, T2, r, b1, b2, v1, v2, rho) + 2 * PartialTimeTwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, t1, T2, r, b1, b2, v1, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2 - dS, X, H, t1, T2, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "cs2" Then 'Cross speed S2^2S1
        EPartialTimeTwoAssetBarrier = (PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2 + dS, X, H, t1, T2, r, b1, b2, v1, v2, rho) - 2 * PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, t1, T2, r, b1, b2, v1, v2, rho) + PartialTimeTwoAssetBarrier(TypeFlag, S1 + dS, S2 - dS, X, H, t1, T2, r, b1, b2, v1, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2 + dS, X, H, t1, T2, r, b1, b2, v1, v2, rho) + 2 * PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, t1, T2, r, b1, b2, v1, v2, rho) - PartialTimeTwoAssetBarrier(TypeFlag, S1 - dS, S2 - dS, X, H, t1, T2, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
...
Public Function PartialTimeTwoAssetBarrier(TypeFlag As String, S1 As Double, S2 As Double, X As Double, H As Double, t1 As Double, T2 As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double) As Double
...
Public Function TwoAssetBarrier(TypeFlag As String, S1 As Double, S2 As Double, X As Double, H As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double) As Double
...
Public Function ETwoAssetBarrier(OutPutFlag As String, TypeFlag As String, S1 As Double, S2 As Double, X As Double, H As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv1" Then 'DGammaDVol S1
        ETwoAssetBarrier = (TwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, T, r, b1, b2, v1 + dv, v2, rho) - 2 * TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2, v1 + dv, v2, rho) + TwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, T, r, b1, b2, v1 + dv, v2, rho) - TwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, T, r, b1, b2, v1 - dv, v2, rho) + 2 * TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2, v1 - dv, v2, rho) - TwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gv2" Then 'DGammaDVol S2
        ETwoAssetBarrier = (TwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, T, r, b1, b2, v1, v2 + dv, rho) - 2 * TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2, v1, v2 + dv, rho) + TwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, T, r, b1, b2, v1, v2 + dv, rho) - TwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, T, r, b1, b2, v1, v2 - dv, rho) + 2 * TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2, v1, v2 - dv, rho) - TwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv1" Then 'Cross GammaDvol S1v2 Cross Zomma
        ETwoAssetBarrier = (TwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, T, r, b1, b2, v1, v2 + dv, rho) - 2 * TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2, v1, v2 + dv, rho) + TwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, T, r, b1, b2, v1, v2 + dv, rho) - TwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, T, r, b1, b2, v1, v2 - dv, rho) + 2 * TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2, v1, v2 - dv, rho) - TwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv2" Then 'Cross GammaDvol S2v1 Cross Zomma
        ETwoAssetBarrier = (TwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, T, r, b1, b2, v1 + dv, v2, rho) - 2 * TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2, v1 + dv, v2, rho) + TwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, T, r, b1, b2, v1 + dv, v2, rho) - TwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, T, r, b1, b2, v1 - dv, v2, rho) + 2 * TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2, v1 - dv, v2, rho) - TwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp1" Then 'GammaP S1
    ...
    ElseIf OutPutFlag = "cg" Then 'Cross gamma
        ETwoAssetBarrier = 1 / (4 * dS * dS) * (TwoAssetBarrier(TypeFlag, S1 + dS, S2 + dS, X, H, T, r, b1, b2, v1, v2, rho) - TwoAssetBarrier(TypeFlag, S1 + dS, S2 - dS, X, H, T, r, b1, b2, v1, v2, rho) - TwoAssetBarrier(TypeFlag, S1 - dS, S2 + dS, X, H, T, r, b1, b2, v1, v2, rho) + TwoAssetBarrier(TypeFlag, S1 - dS, S2 - dS, X, H, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "dddv1" Then 'DDeltaDvol S1 v1
        ETwoAssetBarrier = 1 / (4 * dS * dv) * (TwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, T, r, b1, b2, v1 + dv, v2, rho) - TwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, T, r, b1, b2, v1 - dv, v2, rho) - TwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, T, r, b1, b2, v1 + dv, v2, rho) + TwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "dddv2" Then 'DDeltaDvol S2 v2
        ETwoAssetBarrier = 1 / (4 * dS * dv) * (TwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, T, r, b1, b2, v1, v2 + dv, rho) - TwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, T, r, b1, b2, v1, v2 - dv, rho) - TwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, T, r, b1, b2, v1, v2 + dv, rho) + TwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv1" Then 'Cross vanna 1
        ETwoAssetBarrier = 1 / (4 * dS * dv) * (TwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, T, r, b1, b2, v1, v2 + dv, rho) - TwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, T, r, b1, b2, v1, v2 - dv, rho) - TwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, T, r, b1, b2, v1, v2 + dv, rho) + TwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv2" Then 'Cross vanna 2
        ETwoAssetBarrier = 1 / (4 * dS * dv) * (TwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, T, r, b1, b2, v1 + dv, v2, rho) - TwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, T, r, b1, b2, v1 - dv, v2, rho) - TwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, T, r, b1, b2, v1 + dv, v2, rho) + TwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "v1" Then 'Vega v1
    ...
    ElseIf OutPutFlag = "cv" Then 'Cross vomma
        ETwoAssetBarrier = 1 / (4 * dv * dv) * (TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2, v1 + dv, v2 + dv, rho) - TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2, v1 - dv, v2 + dv, rho) - TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2, v1 + dv, v2 - dv, rho) + TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2, v1 - dv, v2 - dv, rho)) / 10000
    ElseIf OutPutFlag = "vp1" Then 'VegaP v1
    ...
    ElseIf OutPutFlag = "b2" Then 'Carry S2
        ETwoAssetBarrier = (TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2 + 0.01, v1, v2, rho) - TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2 - 0.01, v1, v2, rho)) / (2)
    ElseIf OutPutFlag = "s1" Then 'Speed S1
        ETwoAssetBarrier = 1 / dS ^ 3 * (TwoAssetBarrier(TypeFlag, S1 + 2 * dS, S2, X, H, T, r, b1, b2, v1, v2, rho) - 3 * TwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, T, r, b1, b2, v1, v2, rho) + 3 * TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2, v1, v2, rho) - TwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "s2" Then 'Speed S2
        ETwoAssetBarrier = 1 / dS ^ 3 * (TwoAssetBarrier(TypeFlag, S1, S2 + 2 * dS, X, H, T, r, b1, b2, v1, v2, rho) - 3 * TwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, T, r, b1, b2, v1, v2, rho) + 3 * TwoAssetBarrier(TypeFlag, S1, S2, X, H, T, r, b1, b2, v1, v2, rho) - TwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "cs1" Then 'Cross speed S1^2S2
        ETwoAssetBarrier = (TwoAssetBarrier(TypeFlag, S1 + dS, S2 + dS, X, H, T, r, b1, b2, v1, v2, rho) - 2 * TwoAssetBarrier(TypeFlag, S1, S2 + dS, X, H, T, r, b1, b2, v1, v2, rho) + TwoAssetBarrier(TypeFlag, S1 - dS, S2 + dS, X, H, T, r, b1, b2, v1, v2, rho) - TwoAssetBarrier(TypeFlag, S1 + dS, S2 - dS, X, H, T, r, b1, b2, v1, v2, rho) + 2 * TwoAssetBarrier(TypeFlag, S1, S2 - dS, X, H, T, r, b1, b2, v1, v2, rho) - TwoAssetBarrier(TypeFlag, S1 - dS, S2 - dS, X, H, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "cs2" Then 'Cross speed S2^2S1
        ETwoAssetBarrier = (TwoAssetBarrier(TypeFlag, S1 + dS, S2 + dS, X, H, T, r, b1, b2, v1, v2, rho) - 2 * TwoAssetBarrier(TypeFlag, S1 + dS, S2, X, H, T, r, b1, b2, v1, v2, rho) + TwoAssetBarrier(TypeFlag, S1 + dS, S2 - dS, X, H, T, r, b1, b2, v1, v2, rho) - TwoAssetBarrier(TypeFlag, S1 - dS, S2 + dS, X, H, T, r, b1, b2, v1, v2, rho) + 2 * TwoAssetBarrier(TypeFlag, S1 - dS, S2, X, H, T, r, b1, b2, v1, v2, rho) - TwoAssetBarrier(TypeFlag, S1 - dS, S2 - dS, X, H, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
