...
Public Function GBlackScholesNGreeks(OutPutFlag As String, CallPutFlag As String, S As Double, x As Double, T As Double, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        GBlackScholesNGreeks = (GBlackScholes(CallPutFlag, S + dS, x, T, r, b, v + 0.01) - 2 * GBlackScholes(CallPutFlag, S, x, T, r, b, v + 0.01) + GBlackScholes(CallPutFlag, S - dS, x, T, r, b, v + 0.01) - GBlackScholes(CallPutFlag, S + dS, x, T, r, b, v - 0.01) + 2 * GBlackScholes(CallPutFlag, S, x, T, r, b, v - 0.01) - GBlackScholes(CallPutFlag, S - dS, x, T, r, b, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        GBlackScholesNGreeks = 1 / (4 * dS * 0.01) * (GBlackScholes(CallPutFlag, S + dS, x, T, r, b, v + 0.01) - GBlackScholes(CallPutFlag, S + dS, x, T, r, b, v - 0.01) - GBlackScholes(CallPutFlag, S - dS, x, T, r, b, v + 0.01) + GBlackScholes(CallPutFlag, S - dS, x, T, r, b, v - 0.01)) / 100
    ...
    ElseIf OutPutFlag = "s" Then 'Speed
        GBlackScholesNGreeks = 1 / dS ^ 3 * (GBlackScholes(CallPutFlag, S + 2 * dS, x, T, r, b, v) - 3 * GBlackScholes(CallPutFlag, S + dS, x, T, r, b, v) + 3 * GBlackScholes(CallPutFlag, S, x, T, r, b, v) - GBlackScholes(CallPutFlag, S - dS, x, T, r, b, v))
