...
Public Function ESABRModel(OutPutFlag As String, CallPutFlag As String, F As Double, X As Double, T As Double, r As Double, ATMvol As Double, Beta As Double, VolVol As Double, rho As Double, Optional dS)
