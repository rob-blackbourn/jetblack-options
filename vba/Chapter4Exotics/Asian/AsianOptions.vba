...
Public Function EAsianCurranApprox(OutPutFlag As String, CallPutFlag As String, S As Double, SA As Double, X As Double, t1 As Double, T As Double, n As Long, m As Long, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EAsianCurranApprox = (AsianCurranApprox(CallPutFlag, S + dS, SA, X, t1, T, n, m, r, b, v + 0.01) - 2 * AsianCurranApprox(CallPutFlag, S, SA, X, t1, T, n, m, r, b, v + 0.01) + AsianCurranApprox(CallPutFlag, S - dS, SA, X, t1, T, n, m, r, b, v + 0.01) - AsianCurranApprox(CallPutFlag, S + dS, SA, X, t1, T, n, m, r, b, v - 0.01) + 2 * AsianCurranApprox(CallPutFlag, S, SA, X, t1, T, n, m, r, b, v - 0.01) - AsianCurranApprox(CallPutFlag, S - dS, SA, X, t1, T, n, m, r, b, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EAsianCurranApprox = 1 / (4 * dS * 0.01) * (AsianCurranApprox(CallPutFlag, S + dS, SA, X, t1, T, n, m, r, b, v + 0.01) - AsianCurranApprox(CallPutFlag, S + dS, SA, X, t1, T, n, m, r, b, v - 0.01) - AsianCurranApprox(CallPutFlag, S - dS, SA, X, t1, T, n, m, r, b, v + 0.01) + AsianCurranApprox(CallPutFlag, S - dS, SA, X, t1, T, n, m, r, b, v - 0.01)) / 100
    ...
    ElseIf OutPutFlag = "s" Then 'Speed
        EAsianCurranApprox = 1 / dS ^ 3 * (AsianCurranApprox(CallPutFlag, S + 2 * dS, SA, X, t1, T, n, m, r, b, v) - 3 * AsianCurranApprox(CallPutFlag, S + dS, SA, X, t1, T, n, m, r, b, v) + 3 * AsianCurranApprox(CallPutFlag, S, SA, X, t1, T, n, m, r, b, v) - AsianCurranApprox(CallPutFlag, S - dS, SA, X, t1, T, n, m, r, b, v))
...
Public Function AsianCurranApprox(CallPutFlag As String, S As Double, SA As Double, X As Double, t1 As Double, T As Double, n As Long, m As Long, r As Double, b As Double, v As Double) As Double
...
Public Function DiscreteAsianHHM(CallPutFlag As String, S As Double, SA As Double, X As Double, t1 As Double, T As Double, n As Double, m As Double, r As Double, b As Double, v As Double) As Double
   ...
   End If
    ...
    If b = 0 Then
        EA2 = S * S * Exp(v * v * t1) / (n * n) * ((1 - Exp(v * v * h * n)) / (1 - Exp(v * v * h)) + 2 / (1 - Exp(v * v * h)) * (n - (1 - Exp(v * v * h * n)) / (1 - Exp(v * v * h))))
    Else
...
Public Function EDiscreteAsianHHM(OutPutFlag As String, CallPutFlag As String, S As Double, SA As Double, X As Double, t1 As Double, T As Double, n As Double, m As Double, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EDiscreteAsianHHM = (DiscreteAsianHHM(CallPutFlag, S + dS, SA, X, t1, T, n, m, r, b, v + 0.01) - 2 * DiscreteAsianHHM(CallPutFlag, S, SA, X, t1, T, n, m, r, b, v + 0.01) + DiscreteAsianHHM(CallPutFlag, S - dS, SA, X, t1, T, n, m, r, b, v + 0.01) - DiscreteAsianHHM(CallPutFlag, S + dS, SA, X, t1, T, n, m, r, b, v - 0.01) + 2 * DiscreteAsianHHM(CallPutFlag, S, SA, X, t1, T, n, m, r, b, v - 0.01) - DiscreteAsianHHM(CallPutFlag, S - dS, SA, X, t1, T, n, m, r, b, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EDiscreteAsianHHM = 1 / (4 * dS * 0.01) * (DiscreteAsianHHM(CallPutFlag, S + dS, SA, X, t1, T, n, m, r, b, v + 0.01) - DiscreteAsianHHM(CallPutFlag, S + dS, SA, X, t1, T, n, m, r, b, v - 0.01) - DiscreteAsianHHM(CallPutFlag, S - dS, SA, X, t1, T, n, m, r, b, v + 0.01) + DiscreteAsianHHM(CallPutFlag, S - dS, SA, X, t1, T, n, m, r, b, v - 0.01)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        EDiscreteAsianHHM = (DiscreteAsianHHM(CallPutFlag, S, SA, X, t1, T, n, m, r, b + 0.01, v) - DiscreteAsianHHM(CallPutFlag, S, SA, X, t1, T, n, m, r, b - 0.01, v)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        EDiscreteAsianHHM = 1 / dS ^ 3 * (DiscreteAsianHHM(CallPutFlag, S + 2 * dS, SA, X, t1, T, n, m, r, b, v) - 3 * DiscreteAsianHHM(CallPutFlag, S + dS, SA, X, t1, T, n, m, r, b, v) + 3 * DiscreteAsianHHM(CallPutFlag, S, SA, X, t1, T, n, m, r, b, v) - DiscreteAsianHHM(CallPutFlag, S - dS, SA, X, t1, T, n, m, r, b, v))
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
...
' Arithmetic average rate option
 Public Function TurnbullWakemanAsian(CallPutFlag As String, S As Double, SA As Double, X As Double, T As Double, T2 As Double, r As Double, b As Double, v As Double) As Double
...
Public Function ETurnbullWakemanAsian(OutPutFlag As String, CallPutFlag As String, S As Double, SA As Double, X As Double, T As Double, T2 As Double, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        ETurnbullWakemanAsian = (TurnbullWakemanAsian(CallPutFlag, S + dS, SA, X, T, T2, r, b, v + 0.01) - 2 * TurnbullWakemanAsian(CallPutFlag, S, SA, X, T, T2, r, b, v + 0.01) + TurnbullWakemanAsian(CallPutFlag, S - dS, SA, X, T, T2, r, b, v + 0.01) - TurnbullWakemanAsian(CallPutFlag, S + dS, SA, X, T, T2, r, b, v - 0.01) + 2 * TurnbullWakemanAsian(CallPutFlag, S, SA, X, T, T2, r, b, v - 0.01) - TurnbullWakemanAsian(CallPutFlag, S - dS, SA, X, T, T2, r, b, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        ETurnbullWakemanAsian = 1 / (4 * dS * 0.01) * (TurnbullWakemanAsian(CallPutFlag, S + dS, SA, X, T, T2, r, b, v + 0.01) - TurnbullWakemanAsian(CallPutFlag, S + dS, SA, X, T, T2, r, b, v - 0.01) - TurnbullWakemanAsian(CallPutFlag, S - dS, SA, X, T, T2, r, b, v + 0.01) + TurnbullWakemanAsian(CallPutFlag, S - dS, SA, X, T, T2, r, b, v - 0.01)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        ETurnbullWakemanAsian = (TurnbullWakemanAsian(CallPutFlag, S, SA, X, T, T2, r, b + 0.01, v) - TurnbullWakemanAsian(CallPutFlag, S, SA, X, T, T2, r, b - 0.01, v)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        ETurnbullWakemanAsian = 1 / dS ^ 3 * (TurnbullWakemanAsian(CallPutFlag, S + 2 * dS, SA, X, T, T2, r, b, v) - 3 * TurnbullWakemanAsian(CallPutFlag, S + dS, SA, X, T, T2, r, b, v) + 3 * TurnbullWakemanAsian(CallPutFlag, S, SA, X, T, T2, r, b, v) - TurnbullWakemanAsian(CallPutFlag, S - dS, SA, X, T, T2, r, b, v))
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
