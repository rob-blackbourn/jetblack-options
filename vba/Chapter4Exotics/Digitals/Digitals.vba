...
Public Function EBinaryBarrier(OutPutFlag As String, TypeFlag As Integer, S As Double, x As Double, h As Double, k As Double, T As Double, r As Double, b As Double, v As Double, eta As Integer, phi As Integer, Optional dS) As Double
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        EBinaryBarrier = (BinaryBarrier(TypeFlag, S + dS, x, h, k, T, r, b, v + 0.01, eta, phi) - 2 * BinaryBarrier(TypeFlag, S, x, h, k, T, r, b, v + 0.01, eta, phi) + BinaryBarrier(TypeFlag, S - dS, x, h, k, T, r, b, v + 0.01, eta, phi) - BinaryBarrier(TypeFlag, S + dS, x, h, k, T, r, b, v - 0.01, eta, phi) + 2 * BinaryBarrier(TypeFlag, S, x, h, k, T, r, b, v - 0.01, eta, phi) - BinaryBarrier(TypeFlag, S - dS, x, h, k, T, r, b, v - 0.01, eta, phi)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        EBinaryBarrier = 1 / (4 * dS * 0.01) * (BinaryBarrier(TypeFlag, S + dS, x, h, k, T, r, b, v + 0.01, eta, phi) - BinaryBarrier(TypeFlag, S + dS, x, h, k, T, r, b, v - 0.01, eta, phi) - BinaryBarrier(TypeFlag, S - dS, x, h, k, T, r, b, v + 0.01, eta, phi) + BinaryBarrier(TypeFlag, S - dS, x, h, k, T, r, b, v - 0.01, eta, phi)) / 100
    ...
    ElseIf OutPutFlag = "s" Then 'Speed
        EBinaryBarrier = 1 / dS ^ 3 * (BinaryBarrier(TypeFlag, S + 2 * dS, x, h, k, T, r, b, v, eta, phi) - 3 * BinaryBarrier(TypeFlag, S + dS, x, h, k, T, r, b, v, eta, phi) + 3 * BinaryBarrier(TypeFlag, S, x, h, k, T, r, b, v, eta, phi) - BinaryBarrier(TypeFlag, S - dS, x, h, k, T, r, b, v, eta, phi))
    End If
    
End Function

' Binary barrier options
Public Function BinaryBarrier(TypeFlag As Integer, S As Double, x As Double, h As Double, k As Double, T As Double, r As Double, b As Double, v As Double, eta As Integer, phi As Integer) As Double
...
Public Function CashOrNothing(CallPutFlag As String, S As Double, x As Double, k As Double, T As Double, r As Double, b As Double, v As Double) As Double
