...
Public Function GeometricAverageRateOption(CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double) As Double
...
Public Function MinMaxTwoAverges(TypeFlag As String, S1 As Double, S2 As Double, X As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double) As Double
    ...
    CallMin = S1s * CBND(a1, a6, rho1) + S2s * CBND(a3, a5, rho2) - X * Exp(-r * T) * CBND(a2, a4, rho)
...
Function SpreadApproximation(CallPutFlag As String, S1 As Double, S2 As Double, Q1 As Double, Q2 As Double, X As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double) As Double
...
Public Function EExchangeExchangeOption(OutPutFlag As String, TypeFlag As Integer, S1 As Double, S2 As Double, q As Double, t1 As Double, T2 As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv1" Then 'DGammaDVol S1
        EExchangeExchangeOption = (ExchangeExchangeOption(TypeFlag, S1 + dS, S2, q, t1, T2, r, b1, b2, v1 + dv, v2, rho) - 2 * ExchangeExchangeOption(TypeFlag, S1, S2, q, t1, T2, r, b1, b2, v1 + dv, v2, rho) + ExchangeExchangeOption(TypeFlag, S1 - dS, S2, q, t1, T2, r, b1, b2, v1 + dv, v2, rho) - ExchangeExchangeOption(TypeFlag, S1 + dS, S2, q, t1, T2, r, b1, b2, v1 - dv, v2, rho) + 2 * ExchangeExchangeOption(TypeFlag, S1, S2, q, t1, T2, r, b1, b2, v1 - dv, v2, rho) - ExchangeExchangeOption(TypeFlag, S1 - dS, S2, q, t1, T2, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gv2" Then 'DGammaDVol S2
        EExchangeExchangeOption = (ExchangeExchangeOption(TypeFlag, S1, S2 + dS, q, t1, T2, r, b1, b2, v1, v2 + dv, rho) - 2 * ExchangeExchangeOption(TypeFlag, S1, S2, q, t1, T2, r, b1, b2, v1, v2 + dv, rho) + ExchangeExchangeOption(TypeFlag, S1, S2 - dS, q, t1, T2, r, b1, b2, v1, v2 + dv, rho) - ExchangeExchangeOption(TypeFlag, S1, S2 + dS, q, t1, T2, r, b1, b2, v1, v2 - dv, rho) + 2 * ExchangeExchangeOption(TypeFlag, S1, S2, q, t1, T2, r, b1, b2, v1, v2 - dv, rho) - ExchangeExchangeOption(TypeFlag, S1, S2 - dS, q, t1, T2, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv1" Then 'Cross GammaDvol S1v2 Cross Zomma
        EExchangeExchangeOption = (ExchangeExchangeOption(TypeFlag, S1 + dS, S2, q, t1, T2, r, b1, b2, v1, v2 + dv, rho) - 2 * ExchangeExchangeOption(TypeFlag, S1, S2, q, t1, T2, r, b1, b2, v1, v2 + dv, rho) + ExchangeExchangeOption(TypeFlag, S1 - dS, S2, q, t1, T2, r, b1, b2, v1, v2 + dv, rho) - ExchangeExchangeOption(TypeFlag, S1 + dS, S2, q, t1, T2, r, b1, b2, v1, v2 - dv, rho) + 2 * ExchangeExchangeOption(TypeFlag, S1, S2, q, t1, T2, r, b1, b2, v1, v2 - dv, rho) - ExchangeExchangeOption(TypeFlag, S1 - dS, S2, q, t1, T2, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv2" Then 'Cross GammaDvol S2v1 Cross Zomma
        EExchangeExchangeOption = (ExchangeExchangeOption(TypeFlag, S1, S2 + dS, q, t1, T2, r, b1, b2, v1 + dv, v2, rho) - 2 * ExchangeExchangeOption(TypeFlag, S1, S2, q, t1, T2, r, b1, b2, v1 + dv, v2, rho) + ExchangeExchangeOption(TypeFlag, S1, S2 - dS, q, t1, T2, r, b1, b2, v1 + dv, v2, rho) - ExchangeExchangeOption(TypeFlag, S1, S2 + dS, q, t1, T2, r, b1, b2, v1 - dv, v2, rho) + 2 * ExchangeExchangeOption(TypeFlag, S1, S2, q, t1, T2, r, b1, b2, v1 - dv, v2, rho) - ExchangeExchangeOption(TypeFlag, S1, S2 - dS, q, t1, T2, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ...
    ElseIf OutPutFlag = "cg" Then 'Cross gamma
        EExchangeExchangeOption = 1 / (4 * dS * dS) * (ExchangeExchangeOption(TypeFlag, S1 + dS, S2 + dS, q, t1, T2, r, b1, b2, v1, v2, rho) - ExchangeExchangeOption(TypeFlag, S1 + dS, S2 - dS, q, t1, T2, r, b1, b2, v1, v2, rho) - ExchangeExchangeOption(TypeFlag, S1 - dS, S2 + dS, q, t1, T2, r, b1, b2, v1, v2, rho) + ExchangeExchangeOption(TypeFlag, S1 - dS, S2 - dS, q, t1, T2, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "dddv1" Then 'DDeltaDvol S1 v1
        EExchangeExchangeOption = 1 / (4 * dS * dv) * (ExchangeExchangeOption(TypeFlag, S1 + dS, S2, q, t1, T2, r, b1, b2, v1 + dv, v2, rho) - ExchangeExchangeOption(TypeFlag, S1 + dS, S2, q, t1, T2, r, b1, b2, v1 - dv, v2, rho) - ExchangeExchangeOption(TypeFlag, S1 - dS, S2, q, t1, T2, r, b1, b2, v1 + dv, v2, rho) + ExchangeExchangeOption(TypeFlag, S1 - dS, S2, q, t1, T2, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "dddv2" Then 'DDeltaDvol S2 v2
        EExchangeExchangeOption = 1 / (4 * dS * dv) * (ExchangeExchangeOption(TypeFlag, S1, S2 + dS, q, t1, T2, r, b1, b2, v1, v2 + dv, rho) - ExchangeExchangeOption(TypeFlag, S1, S2 + dS, q, t1, T2, r, b1, b2, v1, v2 - dv, rho) - ExchangeExchangeOption(TypeFlag, S1, S2 - dS, q, t1, T2, r, b1, b2, v1, v2 + dv, rho) + ExchangeExchangeOption(TypeFlag, S1, S2 - dS, q, t1, T2, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv1" Then 'Cross vanna 1
        EExchangeExchangeOption = 1 / (4 * dS * dv) * (ExchangeExchangeOption(TypeFlag, S1 + dS, S2, q, t1, T2, r, b1, b2, v1, v2 + dv, rho) - ExchangeExchangeOption(TypeFlag, S1 + dS, S2, q, t1, T2, r, b1, b2, v1, v2 - dv, rho) - ExchangeExchangeOption(TypeFlag, S1 - dS, S2, q, t1, T2, r, b1, b2, v1, v2 + dv, rho) + ExchangeExchangeOption(TypeFlag, S1 - dS, S2, q, t1, T2, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv2" Then 'Cross vanna 2
        EExchangeExchangeOption = 1 / (4 * dS * dv) * (ExchangeExchangeOption(TypeFlag, S1, S2 + dS, q, t1, T2, r, b1, b2, v1 + dv, v2, rho) - ExchangeExchangeOption(TypeFlag, S1, S2 + dS, q, t1, T2, r, b1, b2, v1 - dv, v2, rho) - ExchangeExchangeOption(TypeFlag, S1, S2 - dS, q, t1, T2, r, b1, b2, v1 + dv, v2, rho) + ExchangeExchangeOption(TypeFlag, S1, S2 - dS, q, t1, T2, r, b1, b2, v1 - dv, v2, rho)) / 100
    ...
    ElseIf OutPutFlag = "cv" Then 'Cross vomma
        EExchangeExchangeOption = 1 / (4 * dv * dv) * (ExchangeExchangeOption(TypeFlag, S1, S2, q, t1, T2, r, b1, b2, v1 + dv, v2 + dv, rho) - ExchangeExchangeOption(TypeFlag, S1, S2, q, t1, T2, r, b1, b2, v1 - dv, v2 + dv, rho) - ExchangeExchangeOption(TypeFlag, S1, S2, q, t1, T2, r, b1, b2, v1 + dv, v2 - dv, rho) + ExchangeExchangeOption(TypeFlag, S1, S2, q, t1, T2, r, b1, b2, v1 - dv, v2 - dv, rho)) / 10000
    ...
    ElseIf OutPutFlag = "s1" Then 'Speed S1
        EExchangeExchangeOption = 1 / dS ^ 3 * (ExchangeExchangeOption(TypeFlag, S1 + 2 * dS, S2, q, t1, T2, r, b1, b2, v1, v2, rho) - 3 * ExchangeExchangeOption(TypeFlag, S1 + dS, S2, q, t1, T2, r, b1, b2, v1, v2, rho) + 3 * ExchangeExchangeOption(TypeFlag, S1, S2, q, t1, T2, r, b1, b2, v1, v2, rho) - ExchangeExchangeOption(TypeFlag, S1 - dS, S2, q, t1, T2, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "s2" Then 'Speed S2
        EExchangeExchangeOption = 1 / dS ^ 3 * (ExchangeExchangeOption(TypeFlag, S1, S2 + 2 * dS, q, t1, T2, r, b1, b2, v1, v2, rho) - 3 * ExchangeExchangeOption(TypeFlag, S1, S2 + dS, q, t1, T2, r, b1, b2, v1, v2, rho) + 3 * ExchangeExchangeOption(TypeFlag, S1, S2, q, t1, T2, r, b1, b2, v1, v2, rho) - ExchangeExchangeOption(TypeFlag, S1, S2 - dS, q, t1, T2, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "cs1" Then 'Cross speed S1^2S2
        EExchangeExchangeOption = (ExchangeExchangeOption(TypeFlag, S1 + dS, S2 + dS, q, t1, T2, r, b1, b2, v1, v2, rho) - 2 * ExchangeExchangeOption(TypeFlag, S1, S2 + dS, q, t1, T2, r, b1, b2, v1, v2, rho) + ExchangeExchangeOption(TypeFlag, S1 - dS, S2 + dS, q, t1, T2, r, b1, b2, v1, v2, rho) - ExchangeExchangeOption(TypeFlag, S1 + dS, S2 - dS, q, t1, T2, r, b1, b2, v1, v2, rho) + 2 * ExchangeExchangeOption(TypeFlag, S1, S2 - dS, q, t1, T2, r, b1, b2, v1, v2, rho) - ExchangeExchangeOption(TypeFlag, S1 - dS, S2 - dS, q, t1, T2, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "cs2" Then 'Cross speed S2^2S1
        EExchangeExchangeOption = (ExchangeExchangeOption(TypeFlag, S1 + dS, S2 + dS, q, t1, T2, r, b1, b2, v1, v2, rho) - 2 * ExchangeExchangeOption(TypeFlag, S1 + dS, S2, q, t1, T2, r, b1, b2, v1, v2, rho) + ExchangeExchangeOption(TypeFlag, S1 + dS, S2 - dS, q, t1, T2, r, b1, b2, v1, v2, rho) - ExchangeExchangeOption(TypeFlag, S1 - dS, S2 + dS, q, t1, T2, r, b1, b2, v1, v2, rho) + 2 * ExchangeExchangeOption(TypeFlag, S1 - dS, S2, q, t1, T2, r, b1, b2, v1, v2, rho) - ExchangeExchangeOption(TypeFlag, S1 - dS, S2 - dS, q, t1, T2, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    End If
End Function

Public Function ESpreadApproximation(OutPutFlag As String, CallPutFlag As String, S1 As Double, S2 As Double, Q1 As Double, Q2 As Double, X As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv1" Then 'DGammaDVol S1
        ESpreadApproximation = (SpreadApproximation(CallPutFlag, S1 + dS, S2, Q1, Q2, X, T, r, b1, b2, v1 + dv, v2, rho) - 2 * SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2, v1 + dv, v2, rho) + SpreadApproximation(CallPutFlag, S1 - dS, S2, Q1, Q2, X, T, r, b1, b2, v1 + dv, v2, rho) - SpreadApproximation(CallPutFlag, S1 + dS, S2, Q1, Q2, X, T, r, b1, b2, v1 - dv, v2, rho) + 2 * SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2, v1 - dv, v2, rho) - SpreadApproximation(CallPutFlag, S1 - dS, S2, Q1, Q2, X, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gv2" Then 'DGammaDVol S2
        ESpreadApproximation = (SpreadApproximation(CallPutFlag, S1, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1, v2 + dv, rho) - 2 * SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2, v1, v2 + dv, rho) + SpreadApproximation(CallPutFlag, S1, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1, v2 + dv, rho) - SpreadApproximation(CallPutFlag, S1, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1, v2 - dv, rho) + 2 * SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2, v1, v2 - dv, rho) - SpreadApproximation(CallPutFlag, S1, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv1" Then 'Cross GammaDvol S1v2 Cross Zomma
        ESpreadApproximation = (SpreadApproximation(CallPutFlag, S1 + dS, S2, Q1, Q2, X, T, r, b1, b2, v1, v2 + dv, rho) - 2 * SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2, v1, v2 + dv, rho) + SpreadApproximation(CallPutFlag, S1 - dS, S2, Q1, Q2, X, T, r, b1, b2, v1, v2 + dv, rho) - SpreadApproximation(CallPutFlag, S1 + dS, S2, Q1, Q2, X, T, r, b1, b2, v1, v2 - dv, rho) + 2 * SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2, v1, v2 - dv, rho) - SpreadApproximation(CallPutFlag, S1 - dS, S2, Q1, Q2, X, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv2" Then 'Cross GammaDvol S2v1 Cross Zomma
        ESpreadApproximation = (SpreadApproximation(CallPutFlag, S1, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1 + dv, v2, rho) - 2 * SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2, v1 + dv, v2, rho) + SpreadApproximation(CallPutFlag, S1, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1 + dv, v2, rho) - SpreadApproximation(CallPutFlag, S1, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1 - dv, v2, rho) + 2 * SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2, v1 - dv, v2, rho) - SpreadApproximation(CallPutFlag, S1, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp1" Then 'GammaP S1
    ...
    ElseIf OutPutFlag = "cg" Then 'Cross gamma
        ESpreadApproximation = 1 / (4 * dS * dS) * (SpreadApproximation(CallPutFlag, S1 + dS, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) - SpreadApproximation(CallPutFlag, S1 + dS, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) - SpreadApproximation(CallPutFlag, S1 - dS, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) + SpreadApproximation(CallPutFlag, S1 - dS, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "dddv1" Then 'DDeltaDvol S1 v1
        ESpreadApproximation = 1 / (4 * dS * dv) * (SpreadApproximation(CallPutFlag, S1 + dS, S2, Q1, Q2, X, T, r, b1, b2, v1 + dv, v2, rho) - SpreadApproximation(CallPutFlag, S1 + dS, S2, Q1, Q2, X, T, r, b1, b2, v1 - dv, v2, rho) - SpreadApproximation(CallPutFlag, S1 - dS, S2, Q1, Q2, X, T, r, b1, b2, v1 + dv, v2, rho) + SpreadApproximation(CallPutFlag, S1 - dS, S2, Q1, Q2, X, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "dddv2" Then 'DDeltaDvol S2 v2
        ESpreadApproximation = 1 / (4 * dS * dv) * (SpreadApproximation(CallPutFlag, S1, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1, v2 + dv, rho) - SpreadApproximation(CallPutFlag, S1, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1, v2 - dv, rho) - SpreadApproximation(CallPutFlag, S1, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1, v2 + dv, rho) + SpreadApproximation(CallPutFlag, S1, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv1" Then 'Cross vanna 1
        ESpreadApproximation = 1 / (4 * dS * dv) * (SpreadApproximation(CallPutFlag, S1 + dS, S2, Q1, Q2, X, T, r, b1, b2, v1, v2 + dv, rho) - SpreadApproximation(CallPutFlag, S1 + dS, S2, Q1, Q2, X, T, r, b1, b2, v1, v2 - dv, rho) - SpreadApproximation(CallPutFlag, S1 - dS, S2, Q1, Q2, X, T, r, b1, b2, v1, v2 + dv, rho) + SpreadApproximation(CallPutFlag, S1 - dS, S2, Q1, Q2, X, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv2" Then 'Cross vanna 2
        ESpreadApproximation = 1 / (4 * dS * dv) * (SpreadApproximation(CallPutFlag, S1, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1 + dv, v2, rho) - SpreadApproximation(CallPutFlag, S1, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1 - dv, v2, rho) - SpreadApproximation(CallPutFlag, S1, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1 + dv, v2, rho) + SpreadApproximation(CallPutFlag, S1, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "v1" Then 'Vega v1
    ...
    ElseIf OutPutFlag = "cv" Then 'Cross vomma
        ESpreadApproximation = 1 / (4 * dv * dv) * (SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2, v1 + dv, v2 + dv, rho) - SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2, v1 - dv, v2 + dv, rho) - SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2, v1 + dv, v2 - dv, rho) + SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2, v1 - dv, v2 - dv, rho)) / 10000
    ElseIf OutPutFlag = "vp1" Then 'VegaP v1
    ...
    ElseIf OutPutFlag = "b2" Then 'Carry S2
        ESpreadApproximation = (SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2 + 0.01, v1, v2, rho) - SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2 - 0.01, v1, v2, rho)) / (2)
    ElseIf OutPutFlag = "s1" Then 'Speed S1
        ESpreadApproximation = 1 / dS ^ 3 * (SpreadApproximation(CallPutFlag, S1 + 2 * dS, S2, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) - 3 * SpreadApproximation(CallPutFlag, S1 + dS, S2, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) + 3 * SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) - SpreadApproximation(CallPutFlag, S1 - dS, S2, Q1, Q2, X, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "s2" Then 'Speed S2
        ESpreadApproximation = 1 / dS ^ 3 * (SpreadApproximation(CallPutFlag, S1, S2 + 2 * dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) - 3 * SpreadApproximation(CallPutFlag, S1, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) + 3 * SpreadApproximation(CallPutFlag, S1, S2, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) - SpreadApproximation(CallPutFlag, S1, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "cs1" Then 'Cross speed S1^2S2
        ESpreadApproximation = (SpreadApproximation(CallPutFlag, S1 + dS, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) - 2 * SpreadApproximation(CallPutFlag, S1, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) + SpreadApproximation(CallPutFlag, S1 - dS, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) - SpreadApproximation(CallPutFlag, S1 + dS, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) + 2 * SpreadApproximation(CallPutFlag, S1, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) - SpreadApproximation(CallPutFlag, S1 - dS, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "cs2" Then 'Cross speed S2^2S1
        ESpreadApproximation = (SpreadApproximation(CallPutFlag, S1 + dS, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) - 2 * SpreadApproximation(CallPutFlag, S1 + dS, S2, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) + SpreadApproximation(CallPutFlag, S1 + dS, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) - SpreadApproximation(CallPutFlag, S1 - dS, S2 + dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) + 2 * SpreadApproximation(CallPutFlag, S1 - dS, S2, Q1, Q2, X, T, r, b1, b2, v1, v2, rho) - SpreadApproximation(CallPutFlag, S1 - dS, S2 - dS, Q1, Q2, X, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
...
Public Function EuropeanExchangeOption(CallPutFlag As String, S1 As Double, S2 As Double, Q1 As Double, Q2 As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double) As Double
...
Public Function EEuropeanExchangeOption(OutPutFlag As String, CallPutFlag As String, S1 As Double, S2 As Double, Q1 As Double, Q2 As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv1" Then 'DGammaDVol S1
        EEuropeanExchangeOption = (EuropeanExchangeOption(CallPutFlag, S1 + dS, S2, Q1, Q2, T, r, b1, b2, v1 + dv, v2, rho) - 2 * EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2, v1 + dv, v2, rho) + EuropeanExchangeOption(CallPutFlag, S1 - dS, S2, Q1, Q2, T, r, b1, b2, v1 + dv, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1 + dS, S2, Q1, Q2, T, r, b1, b2, v1 - dv, v2, rho) + 2 * EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2, v1 - dv, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1 - dS, S2, Q1, Q2, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gv2" Then 'DGammaDVol S2
        EEuropeanExchangeOption = (EuropeanExchangeOption(CallPutFlag, S1, S2 + dS, Q1, Q2, T, r, b1, b2, v1, v2 + dv, rho) - 2 * EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2, v1, v2 + dv, rho) + EuropeanExchangeOption(CallPutFlag, S1, S2 - dS, Q1, Q2, T, r, b1, b2, v1, v2 + dv, rho) - EuropeanExchangeOption(CallPutFlag, S1, S2 + dS, Q1, Q2, T, r, b1, b2, v1, v2 - dv, rho) + 2 * EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2, v1, v2 - dv, rho) - EuropeanExchangeOption(CallPutFlag, S1, S2 - dS, Q1, Q2, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv1" Then 'Cross GammaDvol S1v2 Cross Zomma
        EEuropeanExchangeOption = (EuropeanExchangeOption(CallPutFlag, S1 + dS, S2, Q1, Q2, T, r, b1, b2, v1, v2 + dv, rho) - 2 * EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2, v1, v2 + dv, rho) + EuropeanExchangeOption(CallPutFlag, S1 - dS, S2, Q1, Q2, T, r, b1, b2, v1, v2 + dv, rho) - EuropeanExchangeOption(CallPutFlag, S1 + dS, S2, Q1, Q2, T, r, b1, b2, v1, v2 - dv, rho) + 2 * EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2, v1, v2 - dv, rho) - EuropeanExchangeOption(CallPutFlag, S1 - dS, S2, Q1, Q2, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv2" Then 'Cross GammaDvol S2v1 Cross Zomma
        EEuropeanExchangeOption = (EuropeanExchangeOption(CallPutFlag, S1, S2 + dS, Q1, Q2, T, r, b1, b2, v1 + dv, v2, rho) - 2 * EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2, v1 + dv, v2, rho) + EuropeanExchangeOption(CallPutFlag, S1, S2 - dS, Q1, Q2, T, r, b1, b2, v1 + dv, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1, S2 + dS, Q1, Q2, T, r, b1, b2, v1 - dv, v2, rho) + 2 * EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2, v1 - dv, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1, S2 - dS, Q1, Q2, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp1" Then 'GammaP S1
    ...
    ElseIf OutPutFlag = "cg" Then 'Cross gamma
        EEuropeanExchangeOption = 1 / (4 * dS * dS) * (EuropeanExchangeOption(CallPutFlag, S1 + dS, S2 + dS, Q1, Q2, T, r, b1, b2, v1, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1 + dS, S2 - dS, Q1, Q2, T, r, b1, b2, v1, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1 - dS, S2 + dS, Q1, Q2, T, r, b1, b2, v1, v2, rho) + EuropeanExchangeOption(CallPutFlag, S1 - dS, S2 - dS, Q1, Q2, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "dddv1" Then 'DDeltaDvol S1 v1
        EEuropeanExchangeOption = 1 / (4 * dS * dv) * (EuropeanExchangeOption(CallPutFlag, S1 + dS, S2, Q1, Q2, T, r, b1, b2, v1 + dv, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1 + dS, S2, Q1, Q2, T, r, b1, b2, v1 - dv, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1 - dS, S2, Q1, Q2, T, r, b1, b2, v1 + dv, v2, rho) + EuropeanExchangeOption(CallPutFlag, S1 - dS, S2, Q1, Q2, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "dddv2" Then 'DDeltaDvol S2 v2
        EEuropeanExchangeOption = 1 / (4 * dS * dv) * (EuropeanExchangeOption(CallPutFlag, S1, S2 + dS, Q1, Q2, T, r, b1, b2, v1, v2 + dv, rho) - EuropeanExchangeOption(CallPutFlag, S1, S2 + dS, Q1, Q2, T, r, b1, b2, v1, v2 - dv, rho) - EuropeanExchangeOption(CallPutFlag, S1, S2 - dS, Q1, Q2, T, r, b1, b2, v1, v2 + dv, rho) + EuropeanExchangeOption(CallPutFlag, S1, S2 - dS, Q1, Q2, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv1" Then 'Cross vanna 1
        EEuropeanExchangeOption = 1 / (4 * dS * dv) * (EuropeanExchangeOption(CallPutFlag, S1 + dS, S2, Q1, Q2, T, r, b1, b2, v1, v2 + dv, rho) - EuropeanExchangeOption(CallPutFlag, S1 + dS, S2, Q1, Q2, T, r, b1, b2, v1, v2 - dv, rho) - EuropeanExchangeOption(CallPutFlag, S1 - dS, S2, Q1, Q2, T, r, b1, b2, v1, v2 + dv, rho) + EuropeanExchangeOption(CallPutFlag, S1 - dS, S2, Q1, Q2, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv2" Then 'Cross vanna 2
        EEuropeanExchangeOption = 1 / (4 * dS * dv) * (EuropeanExchangeOption(CallPutFlag, S1, S2 + dS, Q1, Q2, T, r, b1, b2, v1 + dv, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1, S2 + dS, Q1, Q2, T, r, b1, b2, v1 - dv, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1, S2 - dS, Q1, Q2, T, r, b1, b2, v1 + dv, v2, rho) + EuropeanExchangeOption(CallPutFlag, S1, S2 - dS, Q1, Q2, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "v1" Then 'Vega v1
    ...
    ElseIf OutPutFlag = "cv" Then 'Cross vomma
        EEuropeanExchangeOption = 1 / (4 * dv * dv) * (EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2, v1 + dv, v2 + dv, rho) - EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2, v1 - dv, v2 + dv, rho) - EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2, v1 + dv, v2 - dv, rho) + EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2, v1 - dv, v2 - dv, rho)) / 10000
    ElseIf OutPutFlag = "vp1" Then 'VegaP v1
    ...
    ElseIf OutPutFlag = "b2" Then 'Carry S2
        EEuropeanExchangeOption = (EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2 + 0.01, v1, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2 - 0.01, v1, v2, rho)) / (2)
    ElseIf OutPutFlag = "s1" Then 'Speed S1
        EEuropeanExchangeOption = 1 / dS ^ 3 * (EuropeanExchangeOption(CallPutFlag, S1 + 2 * dS, S2, Q1, Q2, T, r, b1, b2, v1, v2, rho) - 3 * EuropeanExchangeOption(CallPutFlag, S1 + dS, S2, Q1, Q2, T, r, b1, b2, v1, v2, rho) + 3 * EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2, v1, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1 - dS, S2, Q1, Q2, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "s2" Then 'Speed S2
        EEuropeanExchangeOption = 1 / dS ^ 3 * (EuropeanExchangeOption(CallPutFlag, S1, S2 + 2 * dS, Q1, Q2, T, r, b1, b2, v1, v2, rho) - 3 * EuropeanExchangeOption(CallPutFlag, S1, S2 + dS, Q1, Q2, T, r, b1, b2, v1, v2, rho) + 3 * EuropeanExchangeOption(CallPutFlag, S1, S2, Q1, Q2, T, r, b1, b2, v1, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1, S2 - dS, Q1, Q2, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "cs1" Then 'Cross speed S1^2S2
        EEuropeanExchangeOption = (EuropeanExchangeOption(CallPutFlag, S1 + dS, S2 + dS, Q1, Q2, T, r, b1, b2, v1, v2, rho) - 2 * EuropeanExchangeOption(CallPutFlag, S1, S2 + dS, Q1, Q2, T, r, b1, b2, v1, v2, rho) + EuropeanExchangeOption(CallPutFlag, S1 - dS, S2 + dS, Q1, Q2, T, r, b1, b2, v1, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1 + dS, S2 - dS, Q1, Q2, T, r, b1, b2, v1, v2, rho) + 2 * EuropeanExchangeOption(CallPutFlag, S1, S2 - dS, Q1, Q2, T, r, b1, b2, v1, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1 - dS, S2 - dS, Q1, Q2, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "cs2" Then 'Cross speed S2^2S1
        EEuropeanExchangeOption = (EuropeanExchangeOption(CallPutFlag, S1 + dS, S2 + dS, Q1, Q2, T, r, b1, b2, v1, v2, rho) - 2 * EuropeanExchangeOption(CallPutFlag, S1 + dS, S2, Q1, Q2, T, r, b1, b2, v1, v2, rho) + EuropeanExchangeOption(CallPutFlag, S1 + dS, S2 - dS, Q1, Q2, T, r, b1, b2, v1, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1 - dS, S2 + dS, Q1, Q2, T, r, b1, b2, v1, v2, rho) + 2 * EuropeanExchangeOption(CallPutFlag, S1 - dS, S2, Q1, Q2, T, r, b1, b2, v1, v2, rho) - EuropeanExchangeOption(CallPutFlag, S1 - dS, S2 - dS, Q1, Q2, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    End If
End Function

' Two asset correlation options
Public Function TwoAssetCorrelation(CallPutFlag As String, S1 As Double, S2 As Double, X1 As Double, X2 As Double, T As Double, b1 As Double, b2 As Double, r As Double, v1 As Double, v2 As Double, rho As Double)
    ...
    If CallPutFlag = "c" Then
        TwoAssetCorrelation = S2 * Exp((b2 - r) * T) * CBND(y2 + v2 * Sqr(T), y1 + rho * v2 * Sqr(T), rho) - X2 * Exp(-r * T) * CBND(y2, y1, rho)
    ElseIf CallPutFlag = "p" Then
        TwoAssetCorrelation = X2 * Exp(-r * T) * CBND(-y2, -y1, rho) - S2 * Exp((b2 - r) * T) * CBND(-y2 - v2 * Sqr(T), -y1 - rho * v2 * Sqr(T), rho)
    End If
End Function

Public Function ETwoAssetCorrelation(OutPutFlag As String, CallPutFlag As String, S1 As Double, S2 As Double, X1 As Double, X2 As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv1" Then 'DGammaDVol S1
        ETwoAssetCorrelation = (TwoAssetCorrelation(CallPutFlag, S1 + dS, S2, X1, X2, T, r, b1, b2, v1 + dv, v2, rho) - 2 * TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2, v1 + dv, v2, rho) + TwoAssetCorrelation(CallPutFlag, S1 - dS, S2, X1, X2, T, r, b1, b2, v1 + dv, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1 + dS, S2, X1, X2, T, r, b1, b2, v1 - dv, v2, rho) + 2 * TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2, v1 - dv, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1 - dS, S2, X1, X2, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gv2" Then 'DGammaDVol S2
        ETwoAssetCorrelation = (TwoAssetCorrelation(CallPutFlag, S1, S2 + dS, X1, X2, T, r, b1, b2, v1, v2 + dv, rho) - 2 * TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2, v1, v2 + dv, rho) + TwoAssetCorrelation(CallPutFlag, S1, S2 - dS, X1, X2, T, r, b1, b2, v1, v2 + dv, rho) - TwoAssetCorrelation(CallPutFlag, S1, S2 + dS, X1, X2, T, r, b1, b2, v1, v2 - dv, rho) + 2 * TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2, v1, v2 - dv, rho) - TwoAssetCorrelation(CallPutFlag, S1, S2 - dS, X1, X2, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv1" Then 'Cross GammaDvol S1v2 Cross Zomma
        ETwoAssetCorrelation = (TwoAssetCorrelation(CallPutFlag, S1 + dS, S2, X1, X2, T, r, b1, b2, v1, v2 + dv, rho) - 2 * TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2, v1, v2 + dv, rho) + TwoAssetCorrelation(CallPutFlag, S1 - dS, S2, X1, X2, T, r, b1, b2, v1, v2 + dv, rho) - TwoAssetCorrelation(CallPutFlag, S1 + dS, S2, X1, X2, T, r, b1, b2, v1, v2 - dv, rho) + 2 * TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2, v1, v2 - dv, rho) - TwoAssetCorrelation(CallPutFlag, S1 - dS, S2, X1, X2, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv2" Then 'Cross GammaDvol S2v1 Cross Zomma
        ETwoAssetCorrelation = (TwoAssetCorrelation(CallPutFlag, S1, S2 + dS, X1, X2, T, r, b1, b2, v1 + dv, v2, rho) - 2 * TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2, v1 + dv, v2, rho) + TwoAssetCorrelation(CallPutFlag, S1, S2 - dS, X1, X2, T, r, b1, b2, v1 + dv, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1, S2 + dS, X1, X2, T, r, b1, b2, v1 - dv, v2, rho) + 2 * TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2, v1 - dv, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1, S2 - dS, X1, X2, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp1" Then 'GammaP S1
    ...
    ElseIf OutPutFlag = "cg" Then 'Cross gamma
        ETwoAssetCorrelation = 1 / (4 * dS * dS) * (TwoAssetCorrelation(CallPutFlag, S1 + dS, S2 + dS, X1, X2, T, r, b1, b2, v1, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1 + dS, S2 - dS, X1, X2, T, r, b1, b2, v1, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1 - dS, S2 + dS, X1, X2, T, r, b1, b2, v1, v2, rho) + TwoAssetCorrelation(CallPutFlag, S1 - dS, S2 - dS, X1, X2, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "dddv1" Then 'DDeltaDvol S1 v1
        ETwoAssetCorrelation = 1 / (4 * dS * dv) * (TwoAssetCorrelation(CallPutFlag, S1 + dS, S2, X1, X2, T, r, b1, b2, v1 + dv, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1 + dS, S2, X1, X2, T, r, b1, b2, v1 - dv, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1 - dS, S2, X1, X2, T, r, b1, b2, v1 + dv, v2, rho) + TwoAssetCorrelation(CallPutFlag, S1 - dS, S2, X1, X2, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "dddv2" Then 'DDeltaDvol S2 v2
        ETwoAssetCorrelation = 1 / (4 * dS * dv) * (TwoAssetCorrelation(CallPutFlag, S1, S2 + dS, X1, X2, T, r, b1, b2, v1, v2 + dv, rho) - TwoAssetCorrelation(CallPutFlag, S1, S2 + dS, X1, X2, T, r, b1, b2, v1, v2 - dv, rho) - TwoAssetCorrelation(CallPutFlag, S1, S2 - dS, X1, X2, T, r, b1, b2, v1, v2 + dv, rho) + TwoAssetCorrelation(CallPutFlag, S1, S2 - dS, X1, X2, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv1" Then 'Cross vanna 1
        ETwoAssetCorrelation = 1 / (4 * dS * dv) * (TwoAssetCorrelation(CallPutFlag, S1 + dS, S2, X1, X2, T, r, b1, b2, v1, v2 + dv, rho) - TwoAssetCorrelation(CallPutFlag, S1 + dS, S2, X1, X2, T, r, b1, b2, v1, v2 - dv, rho) - TwoAssetCorrelation(CallPutFlag, S1 - dS, S2, X1, X2, T, r, b1, b2, v1, v2 + dv, rho) + TwoAssetCorrelation(CallPutFlag, S1 - dS, S2, X1, X2, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv2" Then 'Cross vanna 2
        ETwoAssetCorrelation = 1 / (4 * dS * dv) * (TwoAssetCorrelation(CallPutFlag, S1, S2 + dS, X1, X2, T, r, b1, b2, v1 + dv, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1, S2 + dS, X1, X2, T, r, b1, b2, v1 - dv, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1, S2 - dS, X1, X2, T, r, b1, b2, v1 + dv, v2, rho) + TwoAssetCorrelation(CallPutFlag, S1, S2 - dS, X1, X2, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "v1" Then 'Vega v1
    ...
    ElseIf OutPutFlag = "cv" Then 'Cross vomma
        ETwoAssetCorrelation = 1 / (4 * dv * dv) * (TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2, v1 + dv, v2 + dv, rho) - TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2, v1 - dv, v2 + dv, rho) - TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2, v1 + dv, v2 - dv, rho) + TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2, v1 - dv, v2 - dv, rho)) / 10000
    ElseIf OutPutFlag = "vp1" Then 'VegaP v1
    ...
    ElseIf OutPutFlag = "b2" Then 'Carry S2
        ETwoAssetCorrelation = (TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2 + 0.01, v1, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2 - 0.01, v1, v2, rho)) / (2)
    ElseIf OutPutFlag = "s1" Then 'Speed S1
        ETwoAssetCorrelation = 1 / dS ^ 3 * (TwoAssetCorrelation(CallPutFlag, S1 + 2 * dS, S2, X1, X2, T, r, b1, b2, v1, v2, rho) - 3 * TwoAssetCorrelation(CallPutFlag, S1 + dS, S2, X1, X2, T, r, b1, b2, v1, v2, rho) + 3 * TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2, v1, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1 - dS, S2, X1, X2, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "s2" Then 'Speed S2
        ETwoAssetCorrelation = 1 / dS ^ 3 * (TwoAssetCorrelation(CallPutFlag, S1, S2 + 2 * dS, X1, X2, T, r, b1, b2, v1, v2, rho) - 3 * TwoAssetCorrelation(CallPutFlag, S1, S2 + dS, X1, X2, T, r, b1, b2, v1, v2, rho) + 3 * TwoAssetCorrelation(CallPutFlag, S1, S2, X1, X2, T, r, b1, b2, v1, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1, S2 - dS, X1, X2, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "cs1" Then 'Cross speed S1^2S2
        ETwoAssetCorrelation = (TwoAssetCorrelation(CallPutFlag, S1 + dS, S2 + dS, X1, X2, T, r, b1, b2, v1, v2, rho) - 2 * TwoAssetCorrelation(CallPutFlag, S1, S2 + dS, X1, X2, T, r, b1, b2, v1, v2, rho) + TwoAssetCorrelation(CallPutFlag, S1 - dS, S2 + dS, X1, X2, T, r, b1, b2, v1, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1 + dS, S2 - dS, X1, X2, T, r, b1, b2, v1, v2, rho) + 2 * TwoAssetCorrelation(CallPutFlag, S1, S2 - dS, X1, X2, T, r, b1, b2, v1, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1 - dS, S2 - dS, X1, X2, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "cs2" Then 'Cross speed S2^2S1
        ETwoAssetCorrelation = (TwoAssetCorrelation(CallPutFlag, S1 + dS, S2 + dS, X1, X2, T, r, b1, b2, v1, v2, rho) - 2 * TwoAssetCorrelation(CallPutFlag, S1 + dS, S2, X1, X2, T, r, b1, b2, v1, v2, rho) + TwoAssetCorrelation(CallPutFlag, S1 + dS, S2 - dS, X1, X2, T, r, b1, b2, v1, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1 - dS, S2 + dS, X1, X2, T, r, b1, b2, v1, v2, rho) + 2 * TwoAssetCorrelation(CallPutFlag, S1 - dS, S2, X1, X2, T, r, b1, b2, v1, v2, rho) - TwoAssetCorrelation(CallPutFlag, S1 - dS, S2 - dS, X1, X2, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
...
Public Function OptionsOnTheMaxMin(TypeFlag As String, S1 As Double, S2 As Double, X As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double) As Double
...
Public Function EOptionsOnTheMaxMin(OutPutFlag As String, CallPutFlag As String, S1 As Double, S2 As Double, X As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv1" Then 'DGammaDVol S1
        EOptionsOnTheMaxMin = (OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1 + dv, v2, rho) - 2 * OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 + dv, v2, rho) + OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1 + dv, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1 - dv, v2, rho) + 2 * OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 - dv, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gv2" Then 'DGammaDVol S2
        EOptionsOnTheMaxMin = (OptionsOnTheMaxMin(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1, v2 + dv, rho) - 2 * OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2, v1, v2 + dv, rho) + OptionsOnTheMaxMin(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1, v2 + dv, rho) - OptionsOnTheMaxMin(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1, v2 - dv, rho) + 2 * OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2, v1, v2 - dv, rho) - OptionsOnTheMaxMin(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv1" Then 'Cross GammaDvol S1v2 Cross Zomma
        EOptionsOnTheMaxMin = (OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1, v2 + dv, rho) - 2 * OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2, v1, v2 + dv, rho) + OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1, v2 + dv, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1, v2 - dv, rho) + 2 * OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2, v1, v2 - dv, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv2" Then 'Cross GammaDvol S2v1 Cross Zomma
        EOptionsOnTheMaxMin = (OptionsOnTheMaxMin(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1 + dv, v2, rho) - 2 * OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 + dv, v2, rho) + OptionsOnTheMaxMin(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1 + dv, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1 - dv, v2, rho) + 2 * OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 - dv, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp1" Then 'GammaP S1
    ...
    ElseIf OutPutFlag = "cg" Then 'Cross gamma
        EOptionsOnTheMaxMin = 1 / (4 * dS * dS) * (OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2 + dS, X, T, r, b1, b2, v1, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2 - dS, X, T, r, b1, b2, v1, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2 + dS, X, T, r, b1, b2, v1, v2, rho) + OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2 - dS, X, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "dddv1" Then 'DDeltaDvol S1 v1
        EOptionsOnTheMaxMin = 1 / (4 * dS * dv) * (OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1 + dv, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1 - dv, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1 + dv, v2, rho) + OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "dddv2" Then 'DDeltaDvol S2 v2
        EOptionsOnTheMaxMin = 1 / (4 * dS * dv) * (OptionsOnTheMaxMin(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1, v2 + dv, rho) - OptionsOnTheMaxMin(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1, v2 - dv, rho) - OptionsOnTheMaxMin(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1, v2 + dv, rho) + OptionsOnTheMaxMin(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv1" Then 'Cross vanna 1
        EOptionsOnTheMaxMin = 1 / (4 * dS * dv) * (OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1, v2 + dv, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1, v2 - dv, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1, v2 + dv, rho) + OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv2" Then 'Cross vanna 2
        EOptionsOnTheMaxMin = 1 / (4 * dS * dv) * (OptionsOnTheMaxMin(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1 + dv, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1 - dv, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1 + dv, v2, rho) + OptionsOnTheMaxMin(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "v1" Then 'Vega v1
    ...
    ElseIf OutPutFlag = "cv" Then 'Cross vomma
        EOptionsOnTheMaxMin = 1 / (4 * dv * dv) * (OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 + dv, v2 + dv, rho) - OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 - dv, v2 + dv, rho) - OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 + dv, v2 - dv, rho) + OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 - dv, v2 - dv, rho)) / 10000
    ElseIf OutPutFlag = "vp1" Then 'VegaP v1
    ...
    ElseIf OutPutFlag = "b2" Then 'Carry S2
        EOptionsOnTheMaxMin = (OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2 + 0.01, v1, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2 - 0.01, v1, v2, rho)) / (2)
    ElseIf OutPutFlag = "s1" Then 'Speed S1
        EOptionsOnTheMaxMin = 1 / dS ^ 3 * (OptionsOnTheMaxMin(CallPutFlag, S1 + 2 * dS, S2, X, T, r, b1, b2, v1, v2, rho) - 3 * OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1, v2, rho) + 3 * OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2, v1, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "s2" Then 'Speed S2
        EOptionsOnTheMaxMin = 1 / dS ^ 3 * (OptionsOnTheMaxMin(CallPutFlag, S1, S2 + 2 * dS, X, T, r, b1, b2, v1, v2, rho) - 3 * OptionsOnTheMaxMin(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1, v2, rho) + 3 * OptionsOnTheMaxMin(CallPutFlag, S1, S2, X, T, r, b1, b2, v1, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "cs1" Then 'Cross speed S1^2S2
        EOptionsOnTheMaxMin = (OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2 + dS, X, T, r, b1, b2, v1, v2, rho) - 2 * OptionsOnTheMaxMin(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1, v2, rho) + OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2 + dS, X, T, r, b1, b2, v1, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2 - dS, X, T, r, b1, b2, v1, v2, rho) + 2 * OptionsOnTheMaxMin(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2 - dS, X, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "cs2" Then 'Cross speed S2^2S1
        EOptionsOnTheMaxMin = (OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2 + dS, X, T, r, b1, b2, v1, v2, rho) - 2 * OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1, v2, rho) + OptionsOnTheMaxMin(CallPutFlag, S1 + dS, S2 - dS, X, T, r, b1, b2, v1, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2 + dS, X, T, r, b1, b2, v1, v2, rho) + 2 * OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1, v2, rho) - OptionsOnTheMaxMin(CallPutFlag, S1 - dS, S2 - dS, X, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
...
Public Function EProductOption(OutPutFlag As String, CallPutFlag As String, S1 As Double, S2 As Double, X As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv1" Then 'DGammaDVol S1
        EProductOption = (ProductOption(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1 + dv, v2, rho) - 2 * ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 + dv, v2, rho) + ProductOption(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1 + dv, v2, rho) - ProductOption(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1 - dv, v2, rho) + 2 * ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 - dv, v2, rho) - ProductOption(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gv2" Then 'DGammaDVol S2
        EProductOption = (ProductOption(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1, v2 + dv, rho) - 2 * ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2, v1, v2 + dv, rho) + ProductOption(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1, v2 + dv, rho) - ProductOption(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1, v2 - dv, rho) + 2 * ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2, v1, v2 - dv, rho) - ProductOption(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv1" Then 'Cross GammaDvol S1v2 Cross Zomma
        EProductOption = (ProductOption(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1, v2 + dv, rho) - 2 * ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2, v1, v2 + dv, rho) + ProductOption(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1, v2 + dv, rho) - ProductOption(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1, v2 - dv, rho) + 2 * ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2, v1, v2 - dv, rho) - ProductOption(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1, v2 - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgv2" Then 'Cross GammaDvol S2v1 Cross Zomma
        EProductOption = (ProductOption(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1 + dv, v2, rho) - 2 * ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 + dv, v2, rho) + ProductOption(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1 + dv, v2, rho) - ProductOption(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1 - dv, v2, rho) + 2 * ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 - dv, v2, rho) - ProductOption(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp1" Then 'GammaP S1
    ...
    ElseIf OutPutFlag = "cg" Then 'Cross gamma
        EProductOption = 1 / (4 * dS * dS) * (ProductOption(CallPutFlag, S1 + dS, S2 + dS, X, T, r, b1, b2, v1, v2, rho) - ProductOption(CallPutFlag, S1 + dS, S2 - dS, X, T, r, b1, b2, v1, v2, rho) - ProductOption(CallPutFlag, S1 - dS, S2 + dS, X, T, r, b1, b2, v1, v2, rho) + ProductOption(CallPutFlag, S1 - dS, S2 - dS, X, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "dddv1" Then 'DDeltaDvol S1 v1
        EProductOption = 1 / (4 * dS * dv) * (ProductOption(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1 + dv, v2, rho) - ProductOption(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1 - dv, v2, rho) - ProductOption(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1 + dv, v2, rho) + ProductOption(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "dddv2" Then 'DDeltaDvol S2 v2
        EProductOption = 1 / (4 * dS * dv) * (ProductOption(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1, v2 + dv, rho) - ProductOption(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1, v2 - dv, rho) - ProductOption(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1, v2 + dv, rho) + ProductOption(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv1" Then 'Cross vanna 1
        EProductOption = 1 / (4 * dS * dv) * (ProductOption(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1, v2 + dv, rho) - ProductOption(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1, v2 - dv, rho) - ProductOption(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1, v2 + dv, rho) + ProductOption(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1, v2 - dv, rho)) / 100
    ElseIf OutPutFlag = "cv2" Then 'Cross vanna 2
        EProductOption = 1 / (4 * dS * dv) * (ProductOption(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1 + dv, v2, rho) - ProductOption(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1 - dv, v2, rho) - ProductOption(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1 + dv, v2, rho) + ProductOption(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1 - dv, v2, rho)) / 100
    ElseIf OutPutFlag = "v1" Then 'Vega v1
    ...
    ElseIf OutPutFlag = "cv" Then 'Cross vomma
        EProductOption = 1 / (4 * dv * dv) * (ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 + dv, v2 + dv, rho) - ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 - dv, v2 + dv, rho) - ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 + dv, v2 - dv, rho) + ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 - dv, v2 - dv, rho)) / 10000
    ElseIf OutPutFlag = "vp1" Then 'VegaP v1
    ...
    ElseIf OutPutFlag = "b2" Then 'Carry S2
        EProductOption = (ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2 + 0.01, v1, v2, rho) - ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2 - 0.01, v1, v2, rho)) / (2)
    ElseIf OutPutFlag = "s1" Then 'Speed S1
        EProductOption = 1 / dS ^ 3 * (ProductOption(CallPutFlag, S1 + 2 * dS, S2, X, T, r, b1, b2, v1, v2, rho) - 3 * ProductOption(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1, v2, rho) + 3 * ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2, v1, v2, rho) - ProductOption(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "s2" Then 'Speed S2
        EProductOption = 1 / dS ^ 3 * (ProductOption(CallPutFlag, S1, S2 + 2 * dS, X, T, r, b1, b2, v1, v2, rho) - 3 * ProductOption(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1, v2, rho) + 3 * ProductOption(CallPutFlag, S1, S2, X, T, r, b1, b2, v1, v2, rho) - ProductOption(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1, v2, rho))
    ElseIf OutPutFlag = "cs1" Then 'Cross speed S1^2S2
        EProductOption = (ProductOption(CallPutFlag, S1 + dS, S2 + dS, X, T, r, b1, b2, v1, v2, rho) - 2 * ProductOption(CallPutFlag, S1, S2 + dS, X, T, r, b1, b2, v1, v2, rho) + ProductOption(CallPutFlag, S1 - dS, S2 + dS, X, T, r, b1, b2, v1, v2, rho) - ProductOption(CallPutFlag, S1 + dS, S2 - dS, X, T, r, b1, b2, v1, v2, rho) + 2 * ProductOption(CallPutFlag, S1, S2 - dS, X, T, r, b1, b2, v1, v2, rho) - ProductOption(CallPutFlag, S1 - dS, S2 - dS, X, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "cs2" Then 'Cross speed S2^2S1
        EProductOption = (ProductOption(CallPutFlag, S1 + dS, S2 + dS, X, T, r, b1, b2, v1, v2, rho) - 2 * ProductOption(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1, v2, rho) + ProductOption(CallPutFlag, S1 + dS, S2 - dS, X, T, r, b1, b2, v1, v2, rho) - ProductOption(CallPutFlag, S1 - dS, S2 + dS, X, T, r, b1, b2, v1, v2, rho) + 2 * ProductOption(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1, v2, rho) - ProductOption(CallPutFlag, S1 - dS, S2 - dS, X, T, r, b1, b2, v1, v2, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
...
Public Function EOutPerformance(OutPutFlag As String, CallPutFlag As String, S1 As Double, S2 As Double, X As Double, T As Double, r As Double, b1 As Double, b2 As Double, v1 As Double, v2 As Double, rho As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv1" Then 'DGammaDVol S1
        EOutPerformance = (OutPerformance(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1 + dv, v2, rho) - 2 * OutPerformance(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 + dv, v2, rho) + OutPerformance(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1 + dv, v2, rho) - OutPerformance(CallPutFlag, S1 + dS, S2, X, T, r, b1, b2, v1 - dv, v2, rho) + 2 * OutPerformance(CallPutFlag, S1, S2, X, T, r, b1, b2, v1 - dv, v2, rho) - OutPerformance(CallPutFlag, S1 - dS, S2, X, T, r, b1, b2, v1 - dv, v2, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gv2" Then 'DGammaDVol S2
