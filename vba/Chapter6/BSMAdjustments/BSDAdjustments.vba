...
Public Function ECEVmodel(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, T As Double, r As Double, v As Double, Beta As Double, Optional dS)
...
Public Function CEVmodel(CallPutFlag As String, F As Double, X As Double, T As Double, r As Double, v As Double, Beta As Double) As Double
                
    Dim d1 As Double, d2 As Double, vm As Double, ff As Double
    
    ff = 0.5 * (F + X)
    
    vm = v / ff ^ (1 - Beta) * (1 + (1 - Beta) * (2 + Beta) / 24 * ((F - X) / ff) ^ 2 + (1 - Beta) ^ 2 / 24 * v ^ 2 * T / (ff ^ (2 - 2 * Beta)))
...
Public Function EFrench(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, t1 As Double, T As Double, r As Double, b As Double, v As Double, Optional dS)
...
Public Function GBlackScholesSettlementAdj(CallPutFlag As String, S As Double, X As Double, t1 As Double, T2 As Double, T As Double, r1 As Double, r2 As Double, b As Double, v As Double) As Double
...
Public Function EGBlackScholesSettlementAdj(OutPutFlag As String, CallPutFlag As String, S As Double, X As Double, t1 As Double, T2 As Double, T As Double, r1 As Double, r2 As Double, b As Double, v As Double, Optional dS)
