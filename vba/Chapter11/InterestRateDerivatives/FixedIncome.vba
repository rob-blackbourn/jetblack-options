...
Public Function Swaption(CallPutFlag As String, t1 As Double, m As Double, F As Double, X As Double, T As Double, r As Double, v As Double) As Double
...
Public Function ESwaption(OutputFlag As String, CallPutFlag As String, t1 As Double, m As Double, F As Double, X As Double, T As Double, r As Double, v As Double) As Double
...
Public Function MoneyMarketFuturesOption(CallPutFlag As String, F As Double, X As Double, T As Double, r As Double, v As Double) As Double
...
Function VasicekBondOption(CallPutFlag As String, F As Double, X As Double, tau As Double, T As Double, r As Double, theta As Double, kappa As Double, v As Double) As Double
