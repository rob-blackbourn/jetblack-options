...
Public Function ETakeoverFXoption(OutPutFlag As String, VFirm As Double, N As Double, E As Double, X As Double, T As Double, r As Double, rf As Double, vV As Double, vE As Double, rho As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gvE" Then 'DGammaDVol E
        ETakeoverFXoption = (TakeoverFXoption(VFirm, N, E + dS, X, T, r, rf, vV, vE + dv, rho) - 2 * TakeoverFXoption(VFirm, N, E, X, T, r, rf, vV, vE + dv, rho) + TakeoverFXoption(VFirm, N, E - dS, X, T, r, rf, vV, vE + dv, rho) - TakeoverFXoption(VFirm, N, E + dS, X, T, r, rf, vV, vE - dv, rho) + 2 * TakeoverFXoption(VFirm, N, E, X, T, r, rf, vV, vE - dv, rho) - TakeoverFXoption(VFirm, N, E - dS, X, T, r, rf, vV, vE - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gvS" Then 'DGammaDVol S
        ETakeoverFXoption = (TakeoverFXoption(VFirm + dS, N, E, X, T, r, rf, vV + dv, vE, rho) - 2 * TakeoverFXoption(VFirm, N, E, X, T, r, rf, vV + dv, vE, rho) + TakeoverFXoption(VFirm - dS, N, E, X, T, r, rf, vV + dv, vE, rho) - TakeoverFXoption(VFirm + dS, N, E, X, T, r, rf, vV - dv, vE, rho) + 2 * TakeoverFXoption(VFirm, N, E, X, T, r, rf, vV - dv, vE, rho) - TakeoverFXoption(VFirm - dS, N, E, X, T, r, rf, vV - dv, vE, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgvE" Then 'Cross GammaDvol EvS (Cross Zomma)
        ETakeoverFXoption = (TakeoverFXoption(VFirm, N, E + dS, X, T, r, rf, vV + dv, vE, rho) - 2 * TakeoverFXoption(VFirm, N, E, X, T, r, rf, vV + dv, vE, rho) + TakeoverFXoption(VFirm, N, E - dS, X, T, r, rf, vV + dv, vE, rho) - TakeoverFXoption(VFirm, N, E + dS, X, T, r, rf, vV - dv, vE, rho) + 2 * TakeoverFXoption(VFirm, N, E, X, T, r, rf, vV - dv, vE, rho) - TakeoverFXoption(VFirm, N, E - dS, X, T, r, rf, vV - dv, vE, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgvS" Then 'Cross GammaDvol SvE (Cross Zomma)
        ETakeoverFXoption = (TakeoverFXoption(VFirm + dS, N, E, X, T, r, rf, vV, vE + dv, rho) - 2 * TakeoverFXoption(VFirm, N, E, X, T, r, rf, vV, vE + dv, rho) + TakeoverFXoption(VFirm - dS, N, E, X, T, r, rf, vV, vE + dv, rho) - TakeoverFXoption(VFirm + dS, N, E, X, T, r, rf, vV, vE - dv, rho) + 2 * TakeoverFXoption(VFirm, N, E, X, T, r, rf, vV, vE - dv, rho) - TakeoverFXoption(VFirm - dS, N, E, X, T, r, rf, vV, vE - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ...
    ElseIf OutPutFlag = "cg" Then 'Cross gamma
        ETakeoverFXoption = 1 / (4 * dS * dS) * (TakeoverFXoption(VFirm + dS, N, E + dS, X, T, r, rf, vV, vE, rho) - TakeoverFXoption(VFirm - dS, N, E + dS, X, T, r, rf, vV, vE, rho) - TakeoverFXoption(VFirm + dS, N, E - dS, X, T, r, rf, vV, vE, rho) + TakeoverFXoption(VFirm - dS, N, E - dS, X, T, r, rf, vV, vE, rho))
    ElseIf OutPutFlag = "dddvE" Then 'DDeltaDvol E vE
        ETakeoverFXoption = 1 / (4 * dS * dv) * (TakeoverFXoption(VFirm, N, E + dS, X, T, r, rf, vV, vE + dv, rho) - TakeoverFXoption(VFirm, N, E + dS, X, T, r, rf, vV, vE - dv, rho) - TakeoverFXoption(VFirm, N, E - dS, X, T, r, rf, vV, vE + dv, rho) + TakeoverFXoption(VFirm, N, E - dS, X, T, r, rf, vV, vE - dv, rho)) / 100
    ElseIf OutPutFlag = "dddvS" Then 'DDeltaDvol S vS
        ETakeoverFXoption = 1 / (4 * dS * dv) * (TakeoverFXoption(VFirm + dS, N, E, X, T, r, rf, vV + dv, vE, rho) - TakeoverFXoption(VFirm + dS, N, E, X, T, r, rf, vV - dv, vE, rho) - TakeoverFXoption(VFirm - dS, N, E, X, T, r, rf, vV + dv, vE, rho) + TakeoverFXoption(VFirm - dS, N, E, X, T, r, rf, vV - dv, vE, rho)) / 100
    ElseIf OutPutFlag = "cvE" Then 'Cross vanna E vS
        ETakeoverFXoption = 1 / (4 * dS * dv) * (TakeoverFXoption(VFirm, N, E + dS, X, T, r, rf, vV + dv, vE, rho) - TakeoverFXoption(VFirm, N, E + dS, X, T, r, rf, vV - dv, vE, rho) - TakeoverFXoption(VFirm, N, E - dS, X, T, r, rf, vV + dv, vE, rho) + TakeoverFXoption(VFirm, N, E - dS, X, T, r, rf, vV - dv, vE, rho)) / 100
    ElseIf OutPutFlag = "cvS" Then 'Cross vanna S vE
        ETakeoverFXoption = 1 / (4 * dS * dv) * (TakeoverFXoption(VFirm + dS, N, E, X, T, r, rf, vV, vE + dv, rho) - TakeoverFXoption(VFirm + dS, N, E, X, T, r, rf, vV, vE - dv, rho) - TakeoverFXoption(VFirm - dS, N, E, X, T, r, rf, vV, vE + dv, rho) + TakeoverFXoption(VFirm - dS, N, E, X, T, r, rf, vV, vE - dv, rho)) / 100
    ...
    ElseIf OutPutFlag = "cv" Then 'Cross vomma
        ETakeoverFXoption = 1 / (4 * dv * dv) * (TakeoverFXoption(VFirm, N, E, X, T, r, rf, vV + dv, vE + dv, rho) - TakeoverFXoption(VFirm, N, E, X, T, r, rf, vV - dv, vE + dv, rho) - TakeoverFXoption(VFirm, N, E, X, T, r, rf, vV + dv, vE - dv, rho) + TakeoverFXoption(VFirm, N, E, X, T, r, rf, vV - dv, vE - dv, rho)) / 10000
    ...
    ElseIf OutPutFlag = "sE" Then 'Speed E
        ETakeoverFXoption = 1 / dS ^ 3 * (TakeoverFXoption(VFirm, N, E + 2 * dS, X, T, r, rf, vV, vE, rho) - 3 * TakeoverFXoption(VFirm, N, E + dS, X, T, r, rf, vV, vE, rho) + 3 * TakeoverFXoption(VFirm, N, E, X, T, r, rf, vV, vE, rho) - TakeoverFXoption(VFirm, N, E - dS, X, T, r, rf, vV, vE, rho))
    ElseIf OutPutFlag = "sS" Then 'Speed S
        ETakeoverFXoption = 1 / dS ^ 3 * (TakeoverFXoption(VFirm + 2 * dS, N, E, X, T, r, rf, vV, vE, rho) - 3 * TakeoverFXoption(VFirm + dS, N, E, X, T, r, rf, vV, vE, rho) + 3 * TakeoverFXoption(VFirm, N, E, X, T, r, rf, vV, vE, rho) - TakeoverFXoption(VFirm - dS, N, E, X, T, r, rf, vV, vE, rho))
    ElseIf OutPutFlag = "csE" Then 'Cross speed E^2S
        ETakeoverFXoption = (TakeoverFXoption(VFirm + dS, N, E + dS, X, T, r, rf, vV, vE, rho) - 2 * TakeoverFXoption(VFirm + dS, N, E, X, T, r, rf, vV, vE, rho) + TakeoverFXoption(VFirm, N, E - dS, X, T, r, rf, vV, vE, rho) - TakeoverFXoption(VFirm - dS, N, E + dS, X, T, r, rf, vV, vE, rho) + 2 * TakeoverFXoption(VFirm - dS, N, E, X, T, r, rf, vV, vE, rho) - TakeoverFXoption(VFirm, N, E - dS, X, T, r, rf, vV, vE, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "csS" Then 'Cross speed S^2E
        ETakeoverFXoption = (TakeoverFXoption(VFirm + dS, N, E + dS, X, T, r, rf, vV, vE, rho) - 2 * TakeoverFXoption(VFirm, N, E + dS, X, T, r, rf, vV, vE, rho) + TakeoverFXoption(VFirm, N, E + dS, X, T, r, rf, vV, vE, rho) - TakeoverFXoption(VFirm + dS, N, E - dS, X, T, r, rf, vV, vE, rho) + 2 * TakeoverFXoption(VFirm, N, E - dS, X, T, r, rf, vV, vE, rho) - TakeoverFXoption(VFirm, N, E - dS, X, T, r, rf, vV, vE, rho)) / (2 * dS ^ 3)
...
Public Function TakeoverFXoption(VFirm As Double, N As Double, E As Double, X As Double, T As Double, r As Double, rf As Double, vV As Double, vE As Double, rho As Double) As Double
    ...
    TakeoverFXoption = N * (E * Exp(-rf * T) * CBND(a2 + vE * Sqr(T), -a1 - rho * vE * Sqr(T), -rho) - X * Exp(-r * T) * CBND(-a1, a2, -rho))

End Function

' Foreign equity option struck in domestic currency
Public Function ForEquOptInDomCur(CallPutFlag As String, E As Double, S As Double, X As Double, T As Double, r As Double, q As Double, vS As Double, vE As Double, rho As Double) As Double
...
Public Function EForEquOptInDomCur(OutPutFlag As String, CallPutFlag As String, E As Double, S As Double, X As Double, T As Double, r As Double, q As Double, vE As Double, vS As Double, rho As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gvE" Then 'DGammaDVol E
        EForEquOptInDomCur = (ForEquOptInDomCur(CallPutFlag, E + dS, S, X, T, r, q, vE + dv, vS, rho) - 2 * ForEquOptInDomCur(CallPutFlag, E, S, X, T, r, q, vE + dv, vS, rho) + ForEquOptInDomCur(CallPutFlag, E - dS, S, X, T, r, q, vE + dv, vS, rho) - ForEquOptInDomCur(CallPutFlag, E + dS, S, X, T, r, q, vE - dv, vS, rho) + 2 * ForEquOptInDomCur(CallPutFlag, E, S, X, T, r, q, vE - dv, vS, rho) - ForEquOptInDomCur(CallPutFlag, E - dS, S, X, T, r, q, vE - dv, vS, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gvS" Then 'DGammaDVol S
        EForEquOptInDomCur = (ForEquOptInDomCur(CallPutFlag, E, S + dS, X, T, r, q, vE, vS + dv, rho) - 2 * ForEquOptInDomCur(CallPutFlag, E, S, X, T, r, q, vE, vS + dv, rho) + ForEquOptInDomCur(CallPutFlag, E, S - dS, X, T, r, q, vE, vS + dv, rho) - ForEquOptInDomCur(CallPutFlag, E, S + dS, X, T, r, q, vE, vS - dv, rho) + 2 * ForEquOptInDomCur(CallPutFlag, E, S, X, T, r, q, vE, vS - dv, rho) - ForEquOptInDomCur(CallPutFlag, E, S - dS, X, T, r, q, vE, vS - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgvE" Then 'Cross GammaDvol EvS (Cross Zomma)
        EForEquOptInDomCur = (ForEquOptInDomCur(CallPutFlag, E + dS, S, X, T, r, q, vE, vS + dv, rho) - 2 * ForEquOptInDomCur(CallPutFlag, E, S, X, T, r, q, vE, vS + dv, rho) + ForEquOptInDomCur(CallPutFlag, E - dS, S, X, T, r, q, vE, vS + dv, rho) - ForEquOptInDomCur(CallPutFlag, E + dS, S, X, T, r, q, vE, vS - dv, rho) + 2 * ForEquOptInDomCur(CallPutFlag, E, S, X, T, r, q, vE, vS - dv, rho) - ForEquOptInDomCur(CallPutFlag, E - dS, S, X, T, r, q, vE, vS - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgvS" Then 'Cross GammaDvol SvE (Cross Zomma)
        EForEquOptInDomCur = (ForEquOptInDomCur(CallPutFlag, E, S + dS, X, T, r, q, vE + dv, vS, rho) - 2 * ForEquOptInDomCur(CallPutFlag, E, S, X, T, r, q, vE + dv, vS, rho) + ForEquOptInDomCur(CallPutFlag, E, S - dS, X, T, r, q, vE + dv, vS, rho) - ForEquOptInDomCur(CallPutFlag, E, S + dS, X, T, r, q, vE - dv, vS, rho) + 2 * ForEquOptInDomCur(CallPutFlag, E, S, X, T, r, q, vE - dv, vS, rho) - ForEquOptInDomCur(CallPutFlag, E, S - dS, X, T, r, q, vE - dv, vS, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gpE" Then 'GammaP E
    ...
    ElseIf OutPutFlag = "cg" Then 'Cross gamma
        EForEquOptInDomCur = 1 / (4 * dS * dS) * (ForEquOptInDomCur(CallPutFlag, E + dS, S + dS, X, T, r, q, vE, vS, rho) - ForEquOptInDomCur(CallPutFlag, E + dS, S - dS, X, T, r, q, vE, vS, rho) - ForEquOptInDomCur(CallPutFlag, E - dS, S + dS, X, T, r, q, vE, vS, rho) + ForEquOptInDomCur(CallPutFlag, E - dS, S - dS, X, T, r, q, vE, vS, rho))
    ElseIf OutPutFlag = "dddvE" Then 'DDeltaDvol E vE
        EForEquOptInDomCur = 1 / (4 * dS * dv) * (ForEquOptInDomCur(CallPutFlag, E + dS, S, X, T, r, q, vE + dv, vS, rho) - ForEquOptInDomCur(CallPutFlag, E + dS, S, X, T, r, q, vE - dv, vS, rho) - ForEquOptInDomCur(CallPutFlag, E - dS, S, X, T, r, q, vE + dv, vS, rho) + ForEquOptInDomCur(CallPutFlag, E - dS, S, X, T, r, q, vE - dv, vS, rho)) / 100
    ElseIf OutPutFlag = "dddvS" Then 'DDeltaDvol S vS
        EForEquOptInDomCur = 1 / (4 * dS * dv) * (ForEquOptInDomCur(CallPutFlag, E, S + dS, X, T, r, q, vE, vS + dv, rho) - ForEquOptInDomCur(CallPutFlag, E, S + dS, X, T, r, q, vE, vS - dv, rho) - ForEquOptInDomCur(CallPutFlag, E, S - dS, X, T, r, q, vE, vS + dv, rho) + ForEquOptInDomCur(CallPutFlag, E, S - dS, X, T, r, q, vE, vS - dv, rho)) / 100
    ElseIf OutPutFlag = "cvE" Then 'Cross vanna E vS
        EForEquOptInDomCur = 1 / (4 * dS * dv) * (ForEquOptInDomCur(CallPutFlag, E + dS, S, X, T, r, q, vE, vS + dv, rho) - ForEquOptInDomCur(CallPutFlag, E + dS, S, X, T, r, q, vE, vS - dv, rho) - ForEquOptInDomCur(CallPutFlag, E - dS, S, X, T, r, q, vE, vS + dv, rho) + ForEquOptInDomCur(CallPutFlag, E - dS, S, X, T, r, q, vE, vS - dv, rho)) / 100
    ElseIf OutPutFlag = "cvS" Then 'Cross vanna S vE
        EForEquOptInDomCur = 1 / (4 * dS * dv) * (ForEquOptInDomCur(CallPutFlag, E, S + dS, X, T, r, q, vE + dv, vS, rho) - ForEquOptInDomCur(CallPutFlag, E, S + dS, X, T, r, q, vE - dv, vS, rho) - ForEquOptInDomCur(CallPutFlag, E, S - dS, X, T, r, q, vE + dv, vS, rho) + ForEquOptInDomCur(CallPutFlag, E, S - dS, X, T, r, q, vE - dv, vS, rho)) / 100
    ElseIf OutPutFlag = "vE" Then 'Vega vE
    ...
    ElseIf OutPutFlag = "cv" Then 'Cross vomma
        EForEquOptInDomCur = 1 / (4 * dv * dv) * (ForEquOptInDomCur(CallPutFlag, E, S, X, T, r, q, vE + dv, vS + dv, rho) - ForEquOptInDomCur(CallPutFlag, E, S, X, T, r, q, vE - dv, vS + dv, rho) - ForEquOptInDomCur(CallPutFlag, E, S, X, T, r, q, vE + dv, vS - dv, rho) + ForEquOptInDomCur(CallPutFlag, E, S, X, T, r, q, vE - dv, vS - dv, rho)) / 10000
    ElseIf OutPutFlag = "vpE" Then 'VegaP vE
    ...
    ElseIf OutPutFlag = "sE" Then 'Speed E
        EForEquOptInDomCur = 1 / dS ^ 3 * (ForEquOptInDomCur(CallPutFlag, E + 2 * dS, S, X, T, r, q, vE, vS, rho) - 3 * ForEquOptInDomCur(CallPutFlag, E + dS, S, X, T, r, q, vE, vS, rho) + 3 * ForEquOptInDomCur(CallPutFlag, E, S, X, T, r, q, vE, vS, rho) - ForEquOptInDomCur(CallPutFlag, E - dS, S, X, T, r, q, vE, vS, rho))
    ElseIf OutPutFlag = "sS" Then 'Speed S
        EForEquOptInDomCur = 1 / dS ^ 3 * (ForEquOptInDomCur(CallPutFlag, E, S + 2 * dS, X, T, r, q, vE, vS, rho) - 3 * ForEquOptInDomCur(CallPutFlag, E, S + dS, X, T, r, q, vE, vS, rho) + 3 * ForEquOptInDomCur(CallPutFlag, E, S, X, T, r, q, vE, vS, rho) - ForEquOptInDomCur(CallPutFlag, E, S - dS, X, T, r, q, vE, vS, rho))
    ElseIf OutPutFlag = "csE" Then 'Cross speed E^2S
        EForEquOptInDomCur = (ForEquOptInDomCur(CallPutFlag, E + dS, S + dS, X, T, r, q, vE, vS, rho) - 2 * ForEquOptInDomCur(CallPutFlag, E, S + dS, X, T, r, q, vE, vS, rho) + ForEquOptInDomCur(CallPutFlag, E - dS, S + dS, X, T, r, q, vE, vS, rho) - ForEquOptInDomCur(CallPutFlag, E + dS, S - dS, X, T, r, q, vE, vS, rho) + 2 * ForEquOptInDomCur(CallPutFlag, E, S - dS, X, T, r, q, vE, vS, rho) - ForEquOptInDomCur(CallPutFlag, E - dS, S - dS, X, T, r, q, vE, vS, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "csS" Then 'Cross speed S^2E
        EForEquOptInDomCur = (ForEquOptInDomCur(CallPutFlag, E + dS, S + dS, X, T, r, q, vE, vS, rho) - 2 * ForEquOptInDomCur(CallPutFlag, E + dS, S, X, T, r, q, vE, vS, rho) + ForEquOptInDomCur(CallPutFlag, E + dS, S - dS, X, T, r, q, vE, vS, rho) - ForEquOptInDomCur(CallPutFlag, E - dS, S + dS, X, T, r, q, vE, vS, rho) + 2 * ForEquOptInDomCur(CallPutFlag, E - dS, S, X, T, r, q, vE, vS, rho) - ForEquOptInDomCur(CallPutFlag, E - dS, S - dS, X, T, r, q, vE, vS, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
...
Public Function Quanto(CallPutFlag As String, Ep As Double, S As Double, X As Double, T As Double, r As Double, rf As Double, q As Double, vS As Double, vE As Double, rho As Double) As Double
...
Public Function EQuanto(OutPutFlag As String, CallPutFlag As String, Ep As Double, S As Double, X As Double, T As Double, r As Double, rf As Double, q As Double, vE As Double, vS As Double, rho As Double, Optional dS)
   ...
   ElseIf OutPutFlag = "eS" Then 'Elasticity S
    ...
    ElseIf OutPutFlag = "gvS" Then 'DGammaDVol S
        EQuanto = (Quanto(CallPutFlag, Ep, S + dS, X, T, r, rf, q, vE, vS + dv, rho) - 2 * Quanto(CallPutFlag, Ep, S, X, T, r, rf, q, vE, vS + dv, rho) + Quanto(CallPutFlag, Ep, S - dS, X, T, r, rf, q, vE, vS + dv, rho) - Quanto(CallPutFlag, Ep, S + dS, X, T, r, rf, q, vE, vS - dv, rho) + 2 * Quanto(CallPutFlag, Ep, S, X, T, r, rf, q, vE, vS - dv, rho) - Quanto(CallPutFlag, Ep, S - dS, X, T, r, rf, q, vE, vS - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "dddvE" Then 'DDeltaDvol Ep vE
        EQuanto = 1 / (4 * dS * dv) * (Quanto(CallPutFlag, Ep + dS, S, X, T, r, rf, q, vE + dv, vS, rho) - Quanto(CallPutFlag, Ep + dS, S, X, T, r, rf, q, vE - dv, vS, rho) - Quanto(CallPutFlag, Ep - dS, S, X, T, r, rf, q, vE + dv, vS, rho) + Quanto(CallPutFlag, Ep - dS, S, X, T, r, rf, q, vE - dv, vS, rho)) / 100
    ElseIf OutPutFlag = "dddvS" Then 'DDeltaDvol S vS
        EQuanto = 1 / (4 * dS * dv) * (Quanto(CallPutFlag, Ep, S + dS, X, T, r, rf, q, vE, vS + dv, rho) - Quanto(CallPutFlag, Ep, S + dS, X, T, r, rf, q, vE, vS - dv, rho) - Quanto(CallPutFlag, Ep, S - dS, X, T, r, rf, q, vE, vS + dv, rho) + Quanto(CallPutFlag, Ep, S - dS, X, T, r, rf, q, vE, vS - dv, rho)) / 100
    ElseIf OutPutFlag = "cvE" Then 'Cross vanna E
        EQuanto = 1 / (4 * dS * dv) * (Quanto(CallPutFlag, Ep + dS, S, X, T, r, rf, q, vE, vS + dv, rho) - Quanto(CallPutFlag, Ep + dS, S, X, T, r, rf, q, vE, vS - dv, rho) - Quanto(CallPutFlag, Ep - dS, S, X, T, r, rf, q, vE, vS + dv, rho) + Quanto(CallPutFlag, Ep - dS, S, X, T, r, rf, q, vE, vS - dv, rho)) / 100
    ElseIf OutPutFlag = "cvS" Then 'Cross vanna S
        EQuanto = 1 / (4 * dS * dv) * (Quanto(CallPutFlag, Ep, S + dS, X, T, r, rf, q, vE + dv, vS, rho) - Quanto(CallPutFlag, Ep, S + dS, X, T, r, rf, q, vE - dv, vS, rho) - Quanto(CallPutFlag, Ep, S - dS, X, T, r, rf, q, vE + dv, vS, rho) + Quanto(CallPutFlag, Ep, S - dS, X, T, r, rf, q, vE - dv, vS, rho)) / 100
    ElseIf OutPutFlag = "vE" Then 'Vega vE
    ...
    ElseIf OutPutFlag = "cv" Then 'Cross vomma
        EQuanto = 1 / (4 * dv * dv) * (Quanto(CallPutFlag, Ep, S, X, T, r, rf, q, vE + dv, vS + dv, rho) - Quanto(CallPutFlag, Ep, S, X, T, r, rf, q, vE - dv, vS + dv, rho) - Quanto(CallPutFlag, Ep, S, X, T, r, rf, q, vE + dv, vS - dv, rho) + Quanto(CallPutFlag, Ep, S, X, T, r, rf, q, vE - dv, vS - dv, rho)) / 10000
    ElseIf OutPutFlag = "vpE" Then 'VegaP vE
    ...
    ElseIf OutPutFlag = "sS" Then 'Speed S
        EQuanto = 1 / dS ^ 3 * (Quanto(CallPutFlag, Ep, S + 2 * dS, X, T, r, rf, q, vE, vS, rho) - 3 * Quanto(CallPutFlag, Ep, S + dS, X, T, r, rf, q, vE, vS, rho) + 3 * Quanto(CallPutFlag, Ep, S, X, T, r, rf, q, vE, vS, rho) - Quanto(CallPutFlag, Ep, S - dS, X, T, r, rf, q, vE, vS, rho))
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
...
Public Function EEquityLinkedFXO(OutPutFlag As String, CallPutFlag As String, E As Double, S As Double, X As Double, T As Double, r As Double, rf As Double, q As Double, vE As Double, vS As Double, rho As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gvE" Then 'DGammaDVol E
        EEquityLinkedFXO = (EquityLinkedFXO(CallPutFlag, E + dS, S, X, T, r, rf, q, vE + dv, vS, rho) - 2 * EquityLinkedFXO(CallPutFlag, E, S, X, T, r, rf, q, vE + dv, vS, rho) + EquityLinkedFXO(CallPutFlag, E - dS, S, X, T, r, rf, q, vE + dv, vS, rho) - EquityLinkedFXO(CallPutFlag, E + dS, S, X, T, r, rf, q, vE - dv, vS, rho) + 2 * EquityLinkedFXO(CallPutFlag, E, S, X, T, r, rf, q, vE - dv, vS, rho) - EquityLinkedFXO(CallPutFlag, E - dS, S, X, T, r, rf, q, vE - dv, vS, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "cgvE" Then 'Cross GammaDvol EvS (Cross Zomma)
        EEquityLinkedFXO = (EquityLinkedFXO(CallPutFlag, E + dS, S, X, T, r, rf, q, vE, vS + dv, rho) - 2 * EquityLinkedFXO(CallPutFlag, E, S, X, T, r, rf, q, vE, vS + dv, rho) + EquityLinkedFXO(CallPutFlag, E - dS, S, X, T, r, rf, q, vE, vS + dv, rho) - EquityLinkedFXO(CallPutFlag, E + dS, S, X, T, r, rf, q, vE, vS - dv, rho) + 2 * EquityLinkedFXO(CallPutFlag, E, S, X, T, r, rf, q, vE, vS - dv, rho) - EquityLinkedFXO(CallPutFlag, E - dS, S, X, T, r, rf, q, vE, vS - dv, rho)) / (2 * dv * dS ^ 2) / 100
    ElseIf OutPutFlag = "gpE" Then 'GammaP E
    ...
    ElseIf OutPutFlag = "dddvE" Then 'DDeltaDvol E vE
        EEquityLinkedFXO = 1 / (4 * dS * dv) * (EquityLinkedFXO(CallPutFlag, E + dS, S, X, T, r, rf, q, vE + dv, vS, rho) - EquityLinkedFXO(CallPutFlag, E + dS, S, X, T, r, rf, q, vE - dv, vS, rho) - EquityLinkedFXO(CallPutFlag, E - dS, S, X, T, r, rf, q, vE + dv, vS, rho) + EquityLinkedFXO(CallPutFlag, E - dS, S, X, T, r, rf, q, vE - dv, vS, rho)) / 100
    ElseIf OutPutFlag = "dddvS" Then 'DDeltaDvol S vS
        EEquityLinkedFXO = 1 / (4 * dS * dv) * (EquityLinkedFXO(CallPutFlag, E, S + dS, X, T, r, rf, q, vE, vS + dv, rho) - EquityLinkedFXO(CallPutFlag, E, S + dS, X, T, r, rf, q, vE, vS - dv, rho) - EquityLinkedFXO(CallPutFlag, E, S - dS, X, T, r, rf, q, vE, vS + dv, rho) + EquityLinkedFXO(CallPutFlag, E, S - dS, X, T, r, rf, q, vE, vS - dv, rho)) / 100
    ElseIf OutPutFlag = "cvE" Then 'Cross vanna E vS
        EEquityLinkedFXO = 1 / (4 * dS * dv) * (EquityLinkedFXO(CallPutFlag, E + dS, S, X, T, r, rf, q, vE, vS + dv, rho) - EquityLinkedFXO(CallPutFlag, E + dS, S, X, T, r, rf, q, vE, vS - dv, rho) - EquityLinkedFXO(CallPutFlag, E - dS, S, X, T, r, rf, q, vE, vS + dv, rho) + EquityLinkedFXO(CallPutFlag, E - dS, S, X, T, r, rf, q, vE, vS - dv, rho)) / 100
    ElseIf OutPutFlag = "cvS" Then 'Cross vanna S vE
        EEquityLinkedFXO = 1 / (4 * dS * dv) * (EquityLinkedFXO(CallPutFlag, E, S + dS, X, T, r, rf, q, vE + dv, vS, rho) - EquityLinkedFXO(CallPutFlag, E, S + dS, X, T, r, rf, q, vE - dv, vS, rho) - EquityLinkedFXO(CallPutFlag, E, S - dS, X, T, r, rf, q, vE + dv, vS, rho) + EquityLinkedFXO(CallPutFlag, E, S - dS, X, T, r, rf, q, vE - dv, vS, rho)) / 100
    ElseIf OutPutFlag = "vE" Then 'Vega vE
    ...
    ElseIf OutPutFlag = "cv" Then 'Cross vomma
        EEquityLinkedFXO = 1 / (4 * dv * dv) * (EquityLinkedFXO(CallPutFlag, E, S, X, T, r, rf, q, vE + dv, vS + dv, rho) - EquityLinkedFXO(CallPutFlag, E, S, X, T, r, rf, q, vE - dv, vS + dv, rho) - EquityLinkedFXO(CallPutFlag, E, S, X, T, r, rf, q, vE + dv, vS - dv, rho) + EquityLinkedFXO(CallPutFlag, E, S, X, T, r, rf, q, vE - dv, vS - dv, rho)) / 10000
    ElseIf OutPutFlag = "vpE" Then 'VegaP vE
   ...
   ElseIf OutPutFlag = "f" Then 'Phi
    ...
    ElseIf OutPutFlag = "sE" Then 'Speed E
        EEquityLinkedFXO = 1 / dS ^ 3 * (EquityLinkedFXO(CallPutFlag, E + 2 * dS, S, X, T, r, rf, q, vE, vS, rho) - 3 * EquityLinkedFXO(CallPutFlag, E + dS, S, X, T, r, rf, q, vE, vS, rho) + 3 * EquityLinkedFXO(CallPutFlag, E, S, X, T, r, rf, q, vE, vS, rho) - EquityLinkedFXO(CallPutFlag, E - dS, S, X, T, r, rf, q, vE, vS, rho))
    ElseIf OutPutFlag = "csE" Then 'Cross speed E^2S
        EEquityLinkedFXO = (EquityLinkedFXO(CallPutFlag, E + dS, S + dS, X, T, r, rf, q, vE, vS, rho) - 2 * EquityLinkedFXO(CallPutFlag, E, S + dS, X, T, r, rf, q, vE, vS, rho) + EquityLinkedFXO(CallPutFlag, E - dS, S + dS, X, T, r, rf, q, vE, vS, rho) - EquityLinkedFXO(CallPutFlag, E + dS, S - dS, X, T, r, rf, q, vE, vS, rho) + 2 * EquityLinkedFXO(CallPutFlag, E, S - dS, X, T, r, rf, q, vE, vS, rho) - EquityLinkedFXO(CallPutFlag, E - dS, S - dS, X, T, r, rf, q, vE, vS, rho)) / (2 * dS ^ 3)
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
...
Public Function EquityLinkedFXO(CallPutFlag As String, E As Double, S As Double, X As Double, T As Double, r As Double, rf As Double, q As Double, vS As Double, vE As Double, rho As Double) As Double
