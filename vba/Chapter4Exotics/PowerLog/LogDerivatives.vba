...
Public Function ELogContract_LnS(OutPutFlag As String, S As Double, T As Double, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        ELogContract_LnS = (LogContract_LnS(S + dS, T, r, b, v + 0.01) - 2 * LogContract_LnS(S, T, r, b, v + 0.01) + LogContract_LnS(S - dS, T, r, b, v + 0.01) - LogContract_LnS(S + dS, T, r, b, v - 0.01) + 2 * LogContract_LnS(S, T, r, b, v - 0.01) - LogContract_LnS(S - dS, T, r, b, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        ELogContract_LnS = 1 / (4 * dS * 0.01) * (LogContract_LnS(S + dS, T, r, b, v + 0.01) - LogContract_LnS(S + dS, T, r, b, v - 0.01) - LogContract_LnS(S - dS, T, r, b, v + 0.01) + LogContract_LnS(S - dS, T, r, b, v - 0.01)) / 100
    ...
    ElseIf OutPutFlag = "s" Then 'Speed
        ELogContract_LnS = 1 / dS ^ 3 * (LogContract_LnS(S + 2 * dS, T, r, b, v) - 3 * LogContract_LnS(S + dS, T, r, b, v) + 3 * LogContract_LnS(S, T, r, b, v) - LogContract_LnS(S - dS, T, r, b, v))
    End If
...
Public Function ELogContract_lnSX(OutPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        ELogContract_lnSX = (LogContract_lnSX(S + dS, X, T, r, b, v + 0.01) - 2 * LogContract_lnSX(S, X, T, r, b, v + 0.01) + LogContract_lnSX(S - dS, X, T, r, b, v + 0.01) - LogContract_lnSX(S + dS, X, T, r, b, v - 0.01) + 2 * LogContract_lnSX(S, X, T, r, b, v - 0.01) - LogContract_lnSX(S - dS, X, T, r, b, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        ELogContract_lnSX = 1 / (4 * dS * 0.01) * (LogContract_lnSX(S + dS, X, T, r, b, v + 0.01) - LogContract_lnSX(S + dS, X, T, r, b, v - 0.01) - LogContract_lnSX(S - dS, X, T, r, b, v + 0.01) + LogContract_lnSX(S - dS, X, T, r, b, v - 0.01)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        ELogContract_lnSX = (LogContract_lnSX(S, X, T, r, b + 0.01, v) - LogContract_lnSX(S, X, T, r, b - 0.01, v)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        ELogContract_lnSX = 1 / dS ^ 3 * (LogContract_lnSX(S + 2 * dS, X, T, r, b, v) - 3 * LogContract_lnSX(S + dS, X, T, r, b, v) + 3 * LogContract_lnSX(S, X, T, r, b, v) - LogContract_lnSX(S - dS, X, T, r, b, v))
...
Public Function LogOption(S As Double, X As Double, T As Double, r As Double, b As Double, v As Double) As Double
    Dim d2 As Double
    d2 = (Log(S / X) + (b - v ^ 2 / 2) * T) / (v * Sqr(T))
    LogOption = Exp(-r * T) * ND(d2) * v * Sqr(T) + Exp(-r * T) * (Log(S / X) + (b - v ^ 2 / 2) * T) * CND(d2)
End Function

Public Function ELogOption(OutPutFlag As String, S As Double, X As Double, T As Double, r As Double, b As Double, v As Double, Optional dS)
    ...
    ElseIf OutPutFlag = "gv" Then 'DGammaDVol
        ELogOption = (LogOption(S + dS, X, T, r, b, v + 0.01) - 2 * LogOption(S, X, T, r, b, v + 0.01) + LogOption(S - dS, X, T, r, b, v + 0.01) - LogOption(S + dS, X, T, r, b, v - 0.01) + 2 * LogOption(S, X, T, r, b, v - 0.01) - LogOption(S - dS, X, T, r, b, v - 0.01)) / (2 * 0.01 * dS ^ 2) / 100
    ElseIf OutPutFlag = "gp" Then 'GammaP
    ...
    ElseIf OutPutFlag = "dddv" Then 'DDeltaDvol
        ELogOption = 1 / (4 * dS * 0.01) * (LogOption(S + dS, X, T, r, b, v + 0.01) - LogOption(S + dS, X, T, r, b, v - 0.01) - LogOption(S - dS, X, T, r, b, v + 0.01) + LogOption(S - dS, X, T, r, b, v - 0.01)) / 100
    ElseIf OutPutFlag = "v" Then 'Vega
    ...
    ElseIf OutPutFlag = "b" Then 'Carry
        ELogOption = (LogOption(S, X, T, r, b + 0.01, v) - LogOption(S, X, T, r, b - 0.01, v)) / (2)
    ElseIf OutPutFlag = "s" Then 'Speed
        ELogOption = 1 / dS ^ 3 * (LogOption(S + 2 * dS, X, T, r, b, v) - 3 * LogOption(S + dS, X, T, r, b, v) + 3 * LogOption(S, X, T, r, b, v) - LogOption(S - dS, X, T, r, b, v))
    ElseIf OutPutFlag = "dx" Then 'Strike Delta
